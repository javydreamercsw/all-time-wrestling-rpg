...
- [ ] UI enhancements
  - [ ] In the UI, Title view, there no way to set no challenger once a value is selected. Add an option to clear the challenger selection.
  - [ ] Fan Management
    - [ ] Add functionality to manage fan interactions and engagement within the application.
  ...
  - [x] Add features to allow ordering segment within a show and setting which match segment is the main event.
    - [ ] Improve the narration context so AI is aware of the order of segments and which is the main event. This to allow for better narration generation taking into account events that took place earlier in the show.
    ...
    - [ ] Update documentation to explain how to use the new segment ordering and main event features.
    - [ ] Refactor the existing code to improve maintainability and readability.
