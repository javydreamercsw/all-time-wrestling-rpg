...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-11 (commit da13203cc). Confidence: 100%.
...
- `package-lock.json` — 46 commits/90d (100.0th %ile)
- `package.json` — 71 commits/90d (100.0th %ile)
- `docs/site/guide/campaign.md` — 12 commits/90d (99.9th %ile)
...
### Code health
Three co-equal signals: defect risk 8.26/10 avg, hotspot health 5.61/10 (stable), worst `src/main/java/com/github/javydreamercsw/management/service/campaign/CampaignChapterService.java` at 1.0/10 · maintainability 8.86/10 · performance risk 268 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
