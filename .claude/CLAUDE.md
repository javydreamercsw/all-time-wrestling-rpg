...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-10 (commit 3e7d820e0). Confidence: 100%.
...
Three co-equal signals: defect risk 8.24/10 avg, hotspot health 5.58/10 (stable), worst `src/main/java/com/github/javydreamercsw/management/service/campaign/CampaignChapterService.java` at 1.0/10 · maintainability 8.86/10 · performance risk 267 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
