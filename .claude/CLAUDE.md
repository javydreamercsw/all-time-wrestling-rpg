...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-31 (commit c223de865). Confidence: 100%.
...
- `package.json` — 69 commits/90d (100.0th %ile)
- `package-lock.json` — 46 commits/90d (99.9th %ile)
...
- `src/main/resources/segment_rules.json` — 9 commits/90d (99.8th %ile)

### Code health

Three co-equal signals: defect risk 8.07/10 avg, hotspot health 4.97/10 (stable), worst `src/main/java/com/github/javydreamercsw/management/DataInitializer.java` at 1.0/10 · maintainability 8.78/10 · performance risk 292 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
