...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-07-25 (commit 12ae33da8). Confidence: 100%.
...
- `.claude/CLAUDE.md` — 18 commits/90d (99.8th %ile)

### Code health
Three co-equal signals: defect risk 8.06/10 avg, hotspot health 4.87/10 (stable), worst `src/main/java/com/github/javydreamercsw/management/DataInitializer.java` at 1.0/10 · maintainability 8.77/10 · performance risk 322 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `src/test/java/com/github/javydreamercsw/management/service/campaign/CampaignServiceTest.java` — change entropy — impact −3.0
