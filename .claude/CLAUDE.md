...
Last indexed: 2026-06-26 (commit 54cf89d03). Confidence: 100%.
### Architecture
repo is a Java-based enterprise management platform that consumes relational database schemas and domain-driven business logic to orchestrate wrestler, account, and universe lifecycle states through a structured service layer, ultimately exposing these entities via a Vitepress-powered documentation site. It serves as a centralized backend for managing complex organizational hierarchies and entity relationships, utilizing SQL for persistence and Java for domain modeling. The repository follows a domain-centric architecture organized into functional modules:
### Key Modules
| Module | Purpose |
|--------|---------|
