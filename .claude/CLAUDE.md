...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-08 (commit 5795e9646). Confidence: 100%.
...
- `package-lock.json` — 45 commits/90d (100.0th %ile)
- `package.json` — 66 commits/90d (100.0th %ile)
- `src/test/resources/db/h2-snapshot-v121.sql` — 6 commits/90d (99.9th %ile)
- `docs/site/guide/campaign.md` — 11 commits/90d (99.9th %ile)
- `src/test/resources/db/h2-snapshot-v112.sql` — 6 commits/90d (99.8th %ile)

### Code health

Three co-equal signals: defect risk 8.11/10 avg, hotspot health 5.36/10 (stable), worst `src/main/java/com/github/javydreamercsw/management/DataInitializer.java` at 1.0/10 · maintainability 8.81/10 · performance risk 290 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `docs/MAINTENANCE_GUIDE.md` — change entropy — impact −2.6
