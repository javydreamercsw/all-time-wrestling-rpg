...
Welcome to the Season Management guide. This documentation is automatically generated from the latest game features.
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/automatic-show-creation.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/full-fan-reset.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/recalibrate-fans.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/reset-tier-boundaries.mp4" type="video/mp4">
</video>
