...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/manage-wrestler-injuries.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/edit-wrestler.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/create-wrestler.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/gender-filtering-rankings.mp4" type="video/mp4">
</video>
...
<video controls width="100%" style="border-radius:8px;margin-bottom:1rem">
  <source src="http://localhost:4173/videos/championship-contenders-tier-boundaries.mp4" type="video/mp4">
</video>
