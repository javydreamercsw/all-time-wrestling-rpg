...
* **On-demand Theme Changes:** Users can customize their visual experience by selecting from various color themes (Light, Dark, Retro, High Contrast, Neon) directly from their user profile settings, with persistence across sessions. Administrators can also configure a global default theme.
