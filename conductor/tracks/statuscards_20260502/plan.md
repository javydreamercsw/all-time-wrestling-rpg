...
- [ ] Task: Create `StatusCard` entity to define the cards (name, description, level 1/2 effects, trigger conditions).
    - [ ] Write unit tests for `StatusCard` entity.
    - [ ] Implement `StatusCard` entity.
- [ ] Task: Create `WrestlerStatus` entity to map a `Wrestler` to a `StatusCard` and track the current level.
    - [ ] Write unit tests for `WrestlerStatus` entity.
    - [ ] Implement `WrestlerStatus` entity.
- [ ] Task: Create `WrestlerStatusHistory` entity to log all status changes (gains, flips, losses).
    - [ ] Write unit tests for `WrestlerStatusHistory` entity.
    - [ ] Implement `WrestlerStatusHistory` entity.
- [ ] Task: Create Spring Data JPA repositories for the new entities.
    - [ ] Write integration tests for repositories.
    - [ ] Implement repositories.
- [ ] Task: Create Flyway migration script for the new tables.
