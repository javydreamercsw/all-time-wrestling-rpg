...
- [x] Task: Conductor - User Manual Verification 'Phase 2: Reusable UI Components' (Protocol in workflow.md)

## Phase 3: Wrestler Profile Integration

- [x] Task 3.1: Update `WrestlerProfileView` to include the new Title History section with the timeline and cards.
- [x] Task 3.2: Ensure responsive layout for the history section on the profile page.
- [x] Task 3.3: Write an End-to-End (E2E) test verifying that a wrestler's title history is visible and match links work.
- [x] Task: Conductor - User Manual Verification 'Phase 3: Wrestler Profile Integration' (Protocol in workflow.md)

## Phase 4: Championship Legacy View Integration

- [x] Task 4.1: Update `RankingView` (or a dedicated detail view) to display the complete lineal history of a selected championship.
- [x] Task 4.2: Implement visual highlighting for the "Current Champion" in the legacy timeline.
- [x] Task 4.3: Write an End-to-End (E2E) test verifying the lineal history navigation and correctness of the legacy display.
- [x] Task: Conductor - User Manual Verification 'Phase 4: Championship Legacy View Integration' (Protocol in workflow.md)
