...
## Phase 4: Final Integration and Verification [checkpoint: 2c0e5c1]

* **Objective:** Ensure end-to-end functionality, test coverage, and documentation.
* - [x] Task: Automated and E2E Testing
  - [x] Write integration tests for NPC filtering.
  - [x] Create E2E test: Disable `HURT_BUSINESS` -> Verify MVP is hidden.
  - [x] Create E2E test: Verify Team manager is hidden if their expansion is disabled.
* - [x] Task: Quality Gate Check
  - [x] Verify >80% coverage for new logic.
  - [x] Run full test suite (`./mvnw verify`).
* - [x] Task: Documentation Update
  - [x] Update `GAME_MECHANICS.md` to document the new manager support features.
