...
;              
CREATE USER IF NOT EXISTS "SA" SALT '87278618091f217d' HASH 'de9c3fd197c8e9aed283d28cedcba45a0542f9088a0c53be2f96382fec3b07f0' ADMIN;          
...
-- 155 +/- SELECT COUNT(*) FROM PUBLIC.flyway_schema_history;  
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(-1, NULL, '<< Flyway Schema History table created >>', 'TABLE', '', NULL, 'SA', TIMESTAMP '2026-09-26 00:48:28.202556', 0, TRUE),
(1, '1', 'Initial Schema', 'SQL', 'V1__Initial_Schema.sql', 1115964703, 'SA', TIMESTAMP '2026-09-26 00:48:28.384324', 109, TRUE),
(2, '2', 'DeckCard SetId', 'SQL', 'V2__DeckCard_SetId.sql', -788503740, 'SA', TIMESTAMP '2026-09-26 00:48:28.418487', 20, TRUE),
(3, '3', 'Add CardSet Name Column', 'SQL', 'V3__Add_CardSet_Name_Column.sql', 118948041, 'SA', TIMESTAMP '2026-09-26 00:48:28.434063', 8, TRUE),
(4, '4', 'Update Card Unique Constraint', 'SQL', 'V4__Update_Card_Unique_Constraint.sql', 659202034, 'SA', TIMESTAMP '2026-09-26 00:48:28.441668', 1, TRUE),
(5, '5', 'Add Adjudication Status To Segment', 'SQL', 'V5__Add_Adjudication_Status_To_Segment.sql', 2134148974, 'SA', TIMESTAMP '2026-09-26 00:48:28.456845', 9, TRUE),
(6, '6', 'Add Segment Order And Main Event', 'SQL', 'V6__Add_Segment_Order_And_Main_Event.sql', 619297846, 'SA', TIMESTAMP '2026-09-26 00:48:28.478902', 16, TRUE),
(7, '7', 'Add Inbox Item Table', 'SQL', 'V7__Add_Inbox_Item_Table.sql', 968071477, 'SA', TIMESTAMP '2026-09-26 00:48:28.48658', 1, TRUE),
(8, '8', 'Add Reference Id To Inbox Item', 'SQL', 'V8__Add_Reference_Id_To_Inbox_Item.sql', 989049951, 'SA', TIMESTAMP '2026-09-26 00:48:28.49505', 3, TRUE),
(9, '9', 'Add Bump Addition To Segment Rule', 'SQL', 'V9__Add_Bump_Addition_To_Segment_Rule.sql', 1037211787, 'SA', TIMESTAMP '2026-09-26 00:48:28.505342', 4, TRUE),
(10, '10', 'Add Image Url To Wrestler', 'SQL', 'V10__Add_Image_Url_To_Wrestler.sql', -1445120071, 'SA', TIMESTAMP '2026-09-26 00:48:28.521275', 10, TRUE),
(11, '11', 'Add Expected Matches And Promos To ShowType', 'SQL', 'V11__Add_Expected_Matches_And_Promos_To_ShowType.sql', -1728232004, 'SA', TIMESTAMP '2026-09-26 00:48:28.536356', 9, TRUE),
(12, '12', 'Add Last Sync To Entities', 'SQL', 'V12__Add_Last_Sync_To_Entities.sql', 1145996377, 'SA', TIMESTAMP '2026-09-26 00:48:28.592672', 50, TRUE),
(13, '13', 'Add External Id And Last Sync To SegmentRule', 'SQL', 'V13__Add_External_Id_And_Last_Sync_To_SegmentRule.sql', -566008599, 'SA', TIMESTAMP '2026-09-26 00:48:28.655539', 56, TRUE),
(14, '14', 'Add External Id And Last Sync To Show Template', 'SQL', 'V14__Add_External_Id_And_Last_Sync_To_Show_Template.sql', -1336096513, 'SA', TIMESTAMP '2026-09-26 00:48:28.665024', 4, TRUE),
(15, '15', 'Add Missing Sync Fields', 'SQL', 'V15__Add_Missing_Sync_Fields.sql', 1365334389, 'SA', TIMESTAMP '2026-09-26 00:48:28.7227', 51, TRUE),
(16, '16', 'Create Tier Boundary Table', 'SQL', 'V16__Create_Tier_Boundary_Table.sql', -1179887120, 'SA', TIMESTAMP '2026-09-26 00:48:28.729454', 1, TRUE),
(17, '18', 'Add Inbox Item Target', 'SQL', 'V18__Add_Inbox_Item_Target.sql', -1149624846, 'SA', TIMESTAMP '2026-09-26 00:48:28.735954', 2, TRUE),
(18, '19', 'Remove Reference Id From Inbox Item', 'SQL', 'V19__Remove_Reference_Id_From_Inbox_Item.sql', -1540103389, 'SA', TIMESTAMP '2026-09-26 00:48:28.742498', 2, TRUE),
(19, '20', 'Create Account Tables', 'SQL', 'V20__Create_Account_Tables.sql', 1011977414, 'SA', TIMESTAMP '2026-09-26 00:48:28.752686', 5, TRUE),
(20, '21', 'Insert Default Accounts', 'SQL', 'V21__Insert_Default_Accounts.sql', -1923279678, 'SA', TIMESTAMP '2026-09-26 00:48:28.768799', 8, TRUE),
(21, '22', 'Add Account To Wrestler', 'SQL', 'V22__Add_Account_To_Wrestler.sql', 76510181, 'SA', TIMESTAMP '2026-09-26 00:48:28.781527', 7, TRUE),
(22, '23', 'Rename feud heat event column', 'SQL', 'V23__Rename_feud_heat_event_column.sql', -497843593, 'SA', TIMESTAMP '2026-09-26 00:48:28.786947', 1, TRUE),
(23, '24', 'Create Game Setting Table', 'SQL', 'V24__Create_Game_Setting_Table.sql', 795307327, 'SA', TIMESTAMP '2026-09-26 00:48:28.79239', 1, TRUE),
(24, '25', 'Create Password Reset Token Table', 'SQL', 'V25__Create_Password_Reset_Token_Table.sql', -332824989, 'SA', TIMESTAMP '2026-09-26 00:48:28.799315', 1, TRUE),
(25, '26', 'Add Championship Type To Title', 'SQL', 'V26__Add_Championship_Type_To_Title.sql', -96901047, 'SA', TIMESTAMP '2026-09-26 00:48:28.808482', 4, TRUE);          
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(26, '27', 'Add AI Settings', 'SQL', 'V27__Add_AI_Settings.sql', 1962182044, 'SA', TIMESTAMP '2026-09-26 00:48:28.814792', 1, TRUE),
(27, '28', 'Add Active To Wrestler', 'SQL', 'V28__Add_Active_To_Wrestler.sql', -338805172, 'SA', TIMESTAMP '2026-09-26 00:48:28.825868', 6, TRUE),
(28, '29', 'Create Holiday Table', 'SQL', 'V29__Create_Holiday_Table.sql', 599478441, 'SA', TIMESTAMP '2026-09-26 00:48:28.831559', 1, TRUE),
(29, '30', 'Populate Holiday Table', 'SQL', 'V30__Populate_Holiday_Table.sql', -1793461912, 'SA', TIMESTAMP '2026-09-26 00:48:28.846037', 4, TRUE),
(30, '31', 'Add Manager To Wrestler And Faction And Team', 'SQL', 'V31__Add_Manager_To_Wrestler_And_Faction_And_Team.sql', 378765621, 'SA', TIMESTAMP '2026-09-26 00:48:28.86733', 16, TRUE),
(31, '32', 'Add Description To Npc', 'SQL', 'V32__Add_Description_To_Npc.sql', 630994349, 'SA', TIMESTAMP '2026-09-26 00:48:28.87541', 3, TRUE),
(32, '33', 'Add Include In Rankings To Title', 'SQL', 'V33__Add_Include_In_Rankings_To_Title.sql', -647497361, 'SA', TIMESTAMP '2026-09-26 00:48:28.883803', 3, TRUE),
(33, '34', 'Add Won At Segment To Title Reign', 'SQL', 'V34__Add_Won_At_Segment_To_Title_Reign.sql', -332785961, 'SA', TIMESTAMP '2026-09-26 00:48:28.892402', 3, TRUE),
(34, '35', 'Rename Show Table', 'SQL', 'V35__Rename_Show_Table.sql', -888951185, 'SA', TIMESTAMP '2026-09-26 00:48:28.898175', 1, TRUE),
(35, '36', 'Add Unique Constraint To Wrestler Account', 'SQL', 'V36__Add_Unique_Constraint_To_Wrestler_Account.sql', -1288629724, 'SA', TIMESTAMP '2026-09-26 00:48:28.903353', 1, TRUE),
(36, '37', 'Create Campaign System', 'SQL', 'V37__Create_Campaign_System.sql', 1504350749, 'SA', TIMESTAMP '2026-09-26 00:48:28.959515', 48, TRUE),
(37, '38', 'Add Theme Preference And Default Setting', 'SQL', 'V38__Add_Theme_Preference_And_Default_Setting.sql', -913225845, 'SA', TIMESTAMP '2026-09-26 00:48:28.96973', 5, TRUE),
(38, '39', 'Add League System', 'SQL', 'V39__Add_League_System.sql', 602764493, 'SA', TIMESTAMP '2026-09-26 00:48:29.002553', 26, TRUE),
(39, '41', 'Add Image Url To Npc', 'SQL', 'V41__Add_Image_Url_To_Npc.sql', -1391881153, 'SA', TIMESTAMP '2026-09-26 00:48:29.010432', 3, TRUE),
(40, '42', 'Add Image Url To Show Template', 'SQL', 'V42__Add_Image_Url_To_Show_Template.sql', 2091528606, 'SA', TIMESTAMP '2026-09-26 00:48:29.017695', 3, TRUE),
(41, '43', 'Add Expected Matches And Promos To ShowTemplate', 'SQL', 'V43__Add_Expected_Matches_And_Promos_To_ShowTemplate.sql', -1363888031, 'SA', TIMESTAMP '2026-09-26 00:48:29.026792', 5, TRUE),
(42, '44', 'Add Recurrence And Defense Frequency', 'SQL', 'V44__Add_Recurrence_And_Defense_Frequency.sql', -33215304, 'SA', TIMESTAMP '2026-09-26 00:48:29.052671', 21, TRUE),
(43, '45', 'Remove LocalAI Settings', 'SQL', 'V45__Remove_LocalAI_Settings.sql', -2084740732, 'SA', TIMESTAMP '2026-09-26 00:48:29.06903', 3, TRUE),
(44, '46', 'Create Commentary Tables', 'SQL', 'V46__Create_Commentary_Tables.sql', 1578209880, 'SA', TIMESTAMP '2026-09-26 00:48:29.089102', 14, TRUE),
(45, '47', 'Create News Tables', 'SQL', 'V47__Create_News_Tables.sql', -2003982983, 'SA', TIMESTAMP '2026-09-26 00:48:29.094991', 1, TRUE),
(46, '48', 'Add Gender Constraint To ShowTemplate', 'SQL', 'V48__Add_Gender_Constraint_To_ShowTemplate.sql', -1162501534, 'SA', TIMESTAMP '2026-09-26 00:48:29.103656', 4, TRUE),
(47, '49', 'Add Legacy Fields To Account', 'SQL', 'V49__Add_Legacy_Fields_To_Account.sql', -508336936, 'SA', TIMESTAMP '2026-09-26 00:48:29.122253', 14, TRUE),
(48, '50', 'Create Achievement Tables', 'SQL', 'V50__Create_Achievement_Tables.sql', 533959700, 'SA', TIMESTAMP '2026-09-26 00:48:29.130076', 3, TRUE),
(49, '51', 'Add Affinity To Faction', 'SQL', 'V51__Add_Affinity_To_Faction.sql', 1676214726, 'SA', TIMESTAMP '2026-09-26 00:48:29.13748', 3, TRUE),
(50, '52', 'Remove Rivalry Unique Constraint', 'SQL', 'V52__Remove_Rivalry_Unique_Constraint.sql', 858104277, 'SA', TIMESTAMP '2026-09-26 00:48:30.516104', 1373, TRUE),
(51, '53', 'Create Storyline Tables', 'SQL', 'V53__Create_Storyline_Tables.sql', 1034900586, 'SA', TIMESTAMP '2026-09-26 00:48:30.533157', 10, TRUE);               
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(52, '54', 'Add Npc Attributes', 'SQL', 'V54__Add_Npc_Attributes.sql', 1944315555, 'SA', TIMESTAMP '2026-09-26 00:48:30.5401', 3, TRUE),
(53, '55', 'Add Referee To Segment', 'SQL', 'V55__Add_Referee_To_Segment.sql', -14042474, 'SA', TIMESTAMP '2026-09-26 00:48:30.553066', 9, TRUE),
(54, '56', 'Add No Dq To Segment Rule', 'SQL', 'V56__Add_No_Dq_To_Segment_Rule.sql', 621834710, 'SA', TIMESTAMP '2026-09-26 00:48:30.574156', 7, TRUE),
(55, '57', 'Add Ringside Actions', 'SQL', 'V57__Add_Ringside_Actions.sql', 551019052, 'SA', TIMESTAMP '2026-09-26 00:48:30.583314', 3, TRUE),
(56, '58', 'Add Physical Condition To Wrestler', 'SQL', 'V58__Add_Physical_Condition_To_Wrestler.sql', -2031017789, 'SA', TIMESTAMP '2026-09-26 00:48:30.595097', 7, TRUE),
(57, '59', 'Create Location Arena Tables And Link Show', 'SQL', 'V59__Create_Location_Arena_Tables_And_Link_Show.sql', -777877363, 'SA', TIMESTAMP '2026-09-26 00:48:30.629215', 25, TRUE),
(58, '60', 'Remove Wrestler Account Unique Constraint', 'SQL', 'V60__Remove_Wrestler_Account_Unique_Constraint.sql', -1366350250, 'SA', TIMESTAMP '2026-09-26 00:48:30.636903', 1, TRUE),
(59, '61', 'Add Faction Alignment And Team Fields', 'SQL', 'V61__Add_Faction_Alignment_And_Team_Fields.sql', -393460592, 'SA', TIMESTAMP '2026-09-26 00:48:30.656965', 15, TRUE),
(60, '62', 'Add Updated At To Entities', 'SQL', 'V62__Add_Updated_At_To_Entities.sql', 588199953, 'SA', TIMESTAMP '2026-09-26 00:48:30.76198', 94, TRUE),
(61, '63', 'Initialize Set Enablement Settings', 'SQL', 'V63__Initialize_Set_Enablement_Settings.sql', 727117897, 'SA', TIMESTAMP '2026-09-26 00:48:30.768008', 1, TRUE),
(62, '64', 'Add Expansion Code To Wrestler', 'SQL', 'V64__Add_Expansion_Code_To_Wrestler.sql', -911082154, 'SA', TIMESTAMP '2026-09-26 00:48:30.778893', 6, TRUE),
(63, '65', 'Add Expansion Code To Npc', 'SQL', 'V65__Add_Expansion_Code_To_Npc.sql', 1736603957, 'SA', TIMESTAMP '2026-09-26 00:48:30.78553', 2, TRUE),
(64, '66', 'Add Image Url To Various Entities', 'SQL', 'V66__Add_Image_Url_To_Various_Entities.sql', 1061733307, 'SA', TIMESTAMP '2026-09-26 00:48:30.797498', 8, TRUE),
(65, '67', 'Create Wrestler Relationship Table', 'SQL', 'V67__Create_Wrestler_Relationship_Table.sql', -401169771, 'SA', TIMESTAMP '2026-09-26 00:48:30.804251', 2, TRUE),
(66, '68', 'Add GM Mode Financials And Logistics', 'SQL', 'V68__Add_GM_Mode_Financials_And_Logistics.sql', 1914270991, 'SA', TIMESTAMP '2026-09-26 00:48:30.838664', 30, TRUE),
(67, '69', 'Add Effect Script To Title', 'SQL', 'V69__Add_Effect_Script_To_Title.sql', 1842801306, 'SA', TIMESTAMP '2026-09-26 00:48:30.845267', 2, TRUE),
(68, '70', 'Add Show Attendance And Revenue', 'SQL', 'V70__Add_Show_Attendance_And_Revenue.sql', 1941232678, 'SA', TIMESTAMP '2026-09-26 00:48:30.855838', 7, TRUE),
(69, '71', 'Add Notes To Segment', 'SQL', 'V71__Add_Notes_To_Segment.sql', 1957484762, 'SA', TIMESTAMP '2026-09-26 00:48:30.863482', 3, TRUE),
(70, '72', 'Create Status Card Tables', 'SQL', 'V72__Create_Status_Card_Tables.sql', -1660610380, 'SA', TIMESTAMP '2026-09-26 00:48:30.872308', 4, TRUE),
(71, '73', 'add campaign ability card constraint', 'SQL', 'V73__add_campaign_ability_card_constraint.sql', 215371348, 'SA', TIMESTAMP '2026-09-26 00:48:30.876258', 0, TRUE),
(72, '74', 'Add Team Number To Segment Participant', 'SQL', 'V74__Add_Team_Number_To_Segment_Participant.sql', -1799038452, 'SA', TIMESTAMP '2026-09-26 00:48:30.882122', 2, TRUE),
(73, '75', 'Create Universe Table', 'SQL', 'V75__Create_Universe_Table.sql', 360951789, 'SA', TIMESTAMP '2026-09-26 00:48:30.887625', 1, TRUE),
(74, '76', 'Create Wrestler State Table', 'SQL', 'V76__Create_Wrestler_State_Table.sql', -2083864010, 'SA', TIMESTAMP '2026-09-26 00:48:30.895408', 3, TRUE),
(75, '77', 'Add Universe Membership', 'SQL', 'V77__Add_Universe_Membership.sql', -834416382, 'SA', TIMESTAMP '2026-09-26 00:48:30.901607', 2, TRUE),
(76, '78', 'Add Universe Settings Tables', 'SQL', 'V78__Add_Universe_Settings_Tables.sql', 1718709860, 'SA', TIMESTAMP '2026-09-26 00:48:30.908357', 2, TRUE),
(77, '79', 'Deactivate Same Faction Rivalries', 'SQL', 'V79__Deactivate_Same_Faction_Rivalries.sql', -869186165, 'SA', TIMESTAMP '2026-09-26 00:48:30.916789', 4, TRUE);              
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(78, '80', 'Add RivalryId To Segment', 'SQL', 'V80__Add_RivalryId_To_Segment.sql', 1611206126, 'SA', TIMESTAMP '2026-09-26 00:48:30.924933', 4, TRUE),
(79, '81', 'Decouple Wrestler State', 'SQL', 'V81__Decouple_Wrestler_State.sql', 699881626, 'SA', TIMESTAMP '2026-09-26 00:48:30.954621', 23, TRUE),
(80, '82', 'Drop Deprecated Wrestler Columns', 'SQL', 'V82__Drop_Deprecated_Wrestler_Columns.sql', -479567210, 'SA', TIMESTAMP '2026-09-26 00:48:31.007264', 48, TRUE),
(81, '83', 'Backfill Universe Id', 'SQL', 'V83__Backfill_Universe_Id.sql', -1009108233, 'SA', TIMESTAMP '2026-09-26 00:48:31.012602', 1, TRUE),
(82, '84', 'Add Universe Alignment', 'SQL', 'V84__Add_Universe_Alignment.sql', -1733031706, 'SA', TIMESTAMP '2026-09-26 00:48:31.018989', 2, TRUE),
(83, '85', 'Seed Rivalry Lifecycle Settings', 'SQL', 'V85__Seed_Rivalry_Lifecycle_Settings.sql', 246113347, 'SA', TIMESTAMP '2026-09-26 00:48:31.023608', 0, TRUE),
(84, '86', 'Replace Defense Frequency With Type', 'SQL', 'V86__Replace_Defense_Frequency_With_Type.sql', 2101993557, 'SA', TIMESTAMP '2026-09-26 00:48:31.032315', 5, TRUE),
(85, '87', 'Add Outcome Matrix', 'SQL', 'V87__Add_Outcome_Matrix.sql', 1095930633, 'SA', TIMESTAMP '2026-09-26 00:48:31.038642', 2, TRUE),
(86, '88', 'Add DramaEvent Cleanup Index', 'SQL', 'V88__Add_DramaEvent_Cleanup_Index.sql', 1867476901, 'SA', TIMESTAMP '2026-09-26 00:48:31.042661', 0, TRUE),
(87, '89', 'Link Injury To InjuryType', 'SQL', 'V89__Link_Injury_To_InjuryType.sql', 1285009657, 'SA', TIMESTAMP '2026-09-26 00:48:31.05115', 4, TRUE),
(88, '90', 'Add Wrestler Season Snapshot', 'SQL', 'V90__Add_Wrestler_Season_Snapshot.sql', 710643383, 'SA', TIMESTAMP '2026-09-26 00:48:31.056493', 1, TRUE),
(89, '91', 'Add Universe To Rivalry', 'SQL', 'V91__Add_Universe_To_Rivalry.sql', -1401405617, 'SA', TIMESTAMP '2026-09-26 00:48:31.065344', 5, TRUE),
(90, '92', 'Add Universe Scoped Game Settings', 'SQL', 'V92__Add_Universe_Scoped_Game_Settings.sql', 865269514, 'SA', TIMESTAMP '2026-09-26 00:48:31.073859', 4, TRUE),
(91, '93', 'Migrate Credentials To Default Universe', 'SQL', 'V93__Migrate_Credentials_To_Default_Universe.sql', -1857336965, 'SA', TIMESTAMP '2026-09-26 00:48:31.078591', 1, TRUE),
(92, '94', 'Fix Universe Sequence', 'SQL', 'V94__Fix_Universe_Sequence.sql', -1386687509, 'SA', TIMESTAMP '2026-09-26 00:48:31.087571', 5, TRUE),
(93, '95', 'Create Universe Invite And Join Request Tables', 'SQL', 'V95__Create_Universe_Invite_And_Join_Request_Tables.sql', -1494912489, 'SA', TIMESTAMP '2026-09-26 00:48:31.094755', 2, TRUE),
(94, '96', 'Fix Account FK On Delete Rules', 'SQL', 'V96__Fix_Account_FK_On_Delete_Rules.sql', 1147779210, 'SA', TIMESTAMP '2026-09-26 00:48:31.107874', 9, TRUE),
(95, '97', 'Create Account Tutorial Completion', 'SQL', 'V97__Create_Account_Tutorial_Completion.sql', -558961027, 'SA', TIMESTAMP '2026-09-26 00:48:31.112731', 1, TRUE),
(96, '98', 'Add Current Encounter Id To Campaign State', 'SQL', 'V98__Add_Current_Encounter_Id_To_Campaign_State.sql', 746933968, 'SA', TIMESTAMP '2026-09-26 00:48:31.118872', 2, TRUE),
(97, '99', 'Add Subject To Inbox Item', 'SQL', 'V99__Add_Subject_To_Inbox_Item.sql', 1565727751, 'SA', TIMESTAMP '2026-09-26 00:48:31.123357', 1, TRUE),
(98, '100', 'Add Urgency To Inbox Item', 'SQL', 'V100__Add_Urgency_To_Inbox_Item.sql', 1277308947, 'SA', TIMESTAMP '2026-09-26 00:48:31.128367', 1, TRUE),
(99, '101', 'Add Action Fields To Inbox Item', 'SQL', 'V101__Add_Action_Fields_To_Inbox_Item.sql', 413950941, 'SA', TIMESTAMP '2026-09-26 00:48:31.134579', 2, TRUE),
(100, '102', 'Remove Notion Sync Columns', 'SQL', 'V102__Remove_Notion_Sync_Columns.sql', -1701633824, 'SA', TIMESTAMP '2026-09-26 00:48:31.258754', 116, TRUE),
(101, '103', 'Set Rivalry Resolution Defaults', 'SQL', 'V103__Set_Rivalry_Resolution_Defaults.sql', 182746202, 'SA', TIMESTAMP '2026-09-26 00:48:31.263935', 1, TRUE),
(102, '104', 'Add Expansion Code To Feature Entities', 'SQL', 'V104__Add_Expansion_Code_To_Feature_Entities.sql', 1118552986, 'SA', TIMESTAMP '2026-09-26 00:48:31.273734', 6, TRUE);         
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(103, '105', 'Upgrade Gemini Model Name', 'SQL', 'V105__Upgrade_Gemini_Model_Name.sql', -886320525, 'SA', TIMESTAMP '2026-09-26 00:48:31.277005', 0, TRUE),
(104, '106', 'Add Segment Rule Rules Json', 'SQL', 'V106__Add_Segment_Rule_Rules_Json.sql', 176422839, 'SA', TIMESTAMP '2026-09-26 00:48:31.281275', 2, TRUE),
(105, '107', 'cleanup bogus best friend relationships', 'SQL', 'V107__cleanup_bogus_best_friend_relationships.sql', 1211165419, 'SA', TIMESTAMP '2026-09-26 00:48:31.284009', 0, TRUE),
(106, '108', 'Add Final Momentum To Segment Participant', 'SQL', 'V108__Add_Final_Momentum_To_Segment_Participant.sql', 1898633987, 'SA', TIMESTAMP '2026-09-26 00:48:31.288456', 1, TRUE),
(107, '109', 'Merge Extreme Into No DQ', 'SQL', 'V109__Merge_Extreme_Into_No_DQ.sql', -145341122, 'SA', TIMESTAMP '2026-09-26 00:48:31.291582', 0, TRUE),
(108, '110', 'Add Final Health To Segment Participant', 'SQL', 'V110__Add_Final_Health_To_Segment_Participant.sql', 1552910985, 'SA', TIMESTAMP '2026-09-26 00:48:31.295219', 1, TRUE),
(109, '111', 'Add Guide Json To Segment Type', 'SQL', 'V111__Add_Guide_Json_To_Segment_Type.sql', -1293634829, 'SA', TIMESTAMP '2026-09-26 00:48:31.29959', 2, TRUE),
(110, '112', 'Migrate Campaign Promo Segment Types', 'SQL', 'V112__Migrate_Campaign_Promo_Segment_Types.sql', -23986808, 'SA', TIMESTAMP '2026-09-26 00:48:31.304112', 2, TRUE),
(111, '113', 'Add Is Active To Catalog Entities', 'SQL', 'V113__Add_Is_Active_To_Catalog_Entities.sql', -544962412, 'SA', TIMESTAMP '2026-09-26 00:48:31.314166', 7, TRUE),
(112, '114', 'Drop Injury Is Active Column', 'SQL', 'V114__Drop_Injury_Is_Active_Column.sql', 1001499177, 'SA', TIMESTAMP '2026-09-26 00:48:31.317688', 1, TRUE),
(113, '115', 'Rename Final Momentum To Final Stamina', 'SQL', 'V115__Rename_Final_Momentum_To_Final_Stamina.sql', -335109439, 'SA', TIMESTAMP '2026-09-26 00:48:31.321576', 1, TRUE),
(114, '116', 'Add Title Skill Used To Segment', 'SQL', 'V116__Add_Title_Skill_Used_To_Segment.sql', 1167289880, 'SA', TIMESTAMP '2026-09-26 00:48:31.325538', 1, TRUE),
(115, '117', 'Add Bonus Match Fields To Segment Participant', 'SQL', 'V117__Add_Bonus_Match_Fields_To_Segment_Participant.sql', 2040188674, 'SA', TIMESTAMP '2026-09-26 00:48:31.330397', 3, TRUE),
(116, '118', 'add allows referee stoppage to segment rule', 'SQL', 'V118__add_allows_referee_stoppage_to_segment_rule.sql', -1550473733, 'SA', TIMESTAMP '2026-09-26 00:48:31.33368', 1, TRUE),
(117, '119', 'create account challenge completion', 'SQL', 'V119__create_account_challenge_completion.sql', 114465303, 'SA', TIMESTAMP '2026-09-26 00:48:31.336512', 0, TRUE),
(118, '120', 'add previous last login to account', 'SQL', 'V120__add_previous_last_login_to_account.sql', 1625928857, 'SA', TIMESTAMP '2026-09-26 00:48:31.342231', 3, TRUE),
(119, '121', 'add sender to inbox item', 'SQL', 'V121__add_sender_to_inbox_item.sql', -391355427, 'SA', TIMESTAMP '2026-09-26 00:48:31.345424', 1, TRUE),
(120, '122', 'Add Inbox Retention Setting', 'SQL', 'V122__Add_Inbox_Retention_Setting.sql', -1529445334, 'SA', TIMESTAMP '2026-09-26 00:48:31.348027', 0, TRUE),
(121, '123', 'add quality score to show', 'SQL', 'V123__add_quality_score_to_show.sql', 1409447342, 'SA', TIMESTAMP '2026-09-26 00:48:31.351975', 2, TRUE),
(122, '124', 'add wrestler state history', 'SQL', 'V124__add_wrestler_state_history.sql', 259569851, 'SA', TIMESTAMP '2026-09-26 00:48:31.355993', 1, TRUE),
(123, '125', 'add season award', 'SQL', 'V125__add_season_award.sql', -1782654489, 'SA', TIMESTAMP '2026-09-26 00:48:31.359249', 1, TRUE),
(124, '126', 'add show segment reservation', 'SQL', 'V126__add_show_segment_reservation.sql', 2074824173, 'SA', TIMESTAMP '2026-09-26 00:48:31.363126', 1, TRUE),
(125, '127', 'add tournament', 'SQL', 'V127__add_tournament.sql', 1225194235, 'SA', TIMESTAMP '2026-09-26 00:48:31.36966', 3, TRUE),
(126, '128', 'add booking mode to show', 'SQL', 'V128__add_booking_mode_to_show.sql', 814809843, 'SA', TIMESTAMP '2026-09-26 00:48:31.374298', 2, TRUE),
(127, '129', 'Add Category To ShowType', 'SQL', 'V129__Add_Category_To_ShowType.sql', 1959489143, 'SA', TIMESTAMP '2026-09-26 00:48:31.379746', 2, TRUE);              
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(128, '130', 'Add Unlock Condition To Achievement', 'SQL', 'V130__Add_Unlock_Condition_To_Achievement.sql', 451036812, 'SA', TIMESTAMP '2026-09-26 00:48:31.38352', 1, TRUE),
(129, '131', 'Add Consecutive Weekly Defenses To Title Reign', 'SQL', 'V131__Add_Consecutive_Weekly_Defenses_To_Title_Reign.sql', 62083626, 'SA', TIMESTAMP '2026-09-26 00:48:31.387015', 1, TRUE),
(130, '132', 'Add Consecutive Wins To Wrestler', 'SQL', 'V132__Add_Consecutive_Wins_To_Wrestler.sql', -450298830, 'SA', TIMESTAMP '2026-09-26 00:48:31.391614', 2, TRUE),
(131, '133', 'Add Tournament Segment Rules', 'SQL', 'V133__Add_Tournament_Segment_Rules.sql', -1162541012, 'SA', TIMESTAMP '2026-09-26 00:48:31.395536', 2, TRUE),
(132, '134', 'Add Wrestler Ability', 'SQL', 'V134__Add_Wrestler_Ability.sql', -2005289511, 'SA', TIMESTAMP '2026-09-26 00:48:31.399724', 2, TRUE),
(133, '135', 'Add Unlock Date To Account Achievement', 'SQL', 'V135__Add_Unlock_Date_To_Account_Achievement.sql', -1577363430, 'SA', TIMESTAMP '2026-09-26 00:48:31.402423', 1, TRUE),
(134, '136', 'Add PLE Resolution Attempts To Rivalry', 'SQL', 'V136__Add_PLE_Resolution_Attempts_To_Rivalry.sql', -1976850971, 'SA', TIMESTAMP '2026-09-26 00:48:31.405613', 1, TRUE),
(135, '137', 'Track Last PLE Resolution Show', 'SQL', 'V137__Track_Last_PLE_Resolution_Show.sql', 1288503085, 'SA', TIMESTAMP '2026-09-26 00:48:31.409119', 1, TRUE),
(136, '138', 'Add Feud Script', 'SQL', 'V138__Add_Feud_Script.sql', 1394930702, 'SA', TIMESTAMP '2026-09-26 00:48:31.413785', 2, TRUE),
(137, '139', 'Add Code To Segment Type', 'SQL', 'V139__Add_Code_To_Segment_Type.sql', 2111048012, 'SA', TIMESTAMP '2026-09-26 00:48:31.416879', 1, TRUE),
(138, '140', 'Add Contender Match Flag To Segment', 'SQL', 'V140__Add_Contender_Match_Flag_To_Segment.sql', 1391670763, 'SA', TIMESTAMP '2026-09-26 00:48:31.42016', 1, TRUE),
(139, '141', 'Add Contender Title To Feud Script Beat', 'SQL', 'V141__Add_Contender_Title_To_Feud_Script_Beat.sql', 1629128059, 'SA', TIMESTAMP '2026-09-26 00:48:31.423747', 1, TRUE),
(140, '142', 'Add Wrestler Title Cooldown', 'SQL', 'V142__Add_Wrestler_Title_Cooldown.sql', -1705483603, 'SA', TIMESTAMP '2026-09-26 00:48:31.427446', 2, TRUE),
(141, '143', 'Add Feud Script Beat Participant', 'SQL', 'V143__Add_Feud_Script_Beat_Participant.sql', 107360656, 'SA', TIMESTAMP '2026-09-26 00:48:31.430077', 0, TRUE),
(142, '144', 'Add Teams And Titles To Feud Script Beat', 'SQL', 'V144__Add_Teams_And_Titles_To_Feud_Script_Beat.sql', -1371251633, 'SA', TIMESTAMP '2026-09-26 00:48:31.434763', 3, TRUE),
(143, '145', 'Upgrade Gemini Model To 3 5 Flash Lite', 'SQL', 'V145__Upgrade_Gemini_Model_To_3_5_Flash_Lite.sql', 628397376, 'SA', TIMESTAMP '2026-09-26 00:48:31.436876', 0, TRUE),
(144, '146', 'Add Data Migration History', 'SQL', 'V146__Add_Data_Migration_History.sql', 1757052181, 'SA', TIMESTAMP '2026-09-26 00:48:31.439178', 0, TRUE),
(145, '147', 'Add Event Only To Segment Type', 'SQL', 'V147__Add_Event_Only_To_Segment_Type.sql', 1424543377, 'SA', TIMESTAMP '2026-09-26 00:48:31.441943', 1, TRUE),
(146, '148', 'Add Template Segment Assignments', 'SQL', 'V148__Add_Template_Segment_Assignments.sql', -733164088, 'SA', TIMESTAMP '2026-09-26 00:48:31.44547', 1, TRUE),
(147, '149', 'Add Tournament To Template Assignments', 'SQL', 'V149__Add_Tournament_To_Template_Assignments.sql', 1251207041, 'SA', TIMESTAMP '2026-09-26 00:48:31.448843', 1, TRUE),
(148, '150', 'Add Payoff Show To Tournament', 'SQL', 'V150__Add_Payoff_Show_To_Tournament.sql', 945366640, 'SA', TIMESTAMP '2026-09-26 00:48:31.454808', 4, TRUE),
(149, '151', 'Tournament Match Participants', 'SQL', 'V151__Tournament_Match_Participants.sql', -149407848, 'SA', TIMESTAMP '2026-09-26 00:48:31.457467', 1, TRUE),
(150, '152', 'Tournament Code And Default Entrants', 'SQL', 'V152__Tournament_Code_And_Default_Entrants.sql', 1756557350, 'SA', TIMESTAMP '2026-09-26 00:48:31.462633', 3, TRUE),
(151, '153', 'Add Tournament Spec To Template Assignments', 'SQL', 'V153__Add_Tournament_Spec_To_Template_Assignments.sql', 1369117733, 'SA', TIMESTAMP '2026-09-26 00:48:31.471074', 6, TRUE);       
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(152, '154', 'Add Required Expansions To Show Template', 'SQL', 'V154__Add_Required_Expansions_To_Show_Template.sql', -236189420, 'SA', TIMESTAMP '2026-09-26 00:48:31.473553', 0, TRUE),
(153, '155', 'Tournament Editions', 'SQL', 'V155__Tournament_Editions.sql', 1135675760, 'SA', TIMESTAMP '2026-09-26 00:48:31.479836', 4, TRUE),
(154, '156', 'Tournament Qualifier Group Size', 'SQL', 'V156__Tournament_Qualifier_Group_Size.sql', -1694866026, 'SA', TIMESTAMP '2026-09-26 00:48:31.483162', 1, TRUE);         
...
(1, 'Reference Template', NULL, 1, NULL, TIMESTAMP '2026-09-26 00:48:31.590337', NULL, NULL, NULL, 1, 'NONE', NULL, NULL, NULL, NULL, NULL, NULL, TRUE);           
...
-- 33 +/- SELECT COUNT(*) FROM PUBLIC.GAME_SETTING;            
...
('AI_GEMINI_MODEL_NAME', 'gemini-3.5-flash-lite', 16, NULL),
...
('inbox.retention.days', '90', 33, NULL);            
...
CREATE CACHED TABLE "PUBLIC"."SHOW_TYPE"(
    ...
    "IS_ACTIVE" BOOLEAN DEFAULT TRUE NOT NULL,
    "CATEGORY" CHARACTER VARYING(50) DEFAULT 'OTHER' NOT NULL
);      
...
(1, 'Weekly Show', NULL, TIMESTAMP '2026-09-26 00:48:31.590159', 0, 0, TRUE, 'OTHER'); 
...
(1, 'Reference Wrestler', 12, 2, 12, 2, 12, TIMESTAMP '2026-09-26 00:48:31.588818', FALSE, 'MALE', NULL, NULL, NULL, TRUE, 1, 1, 1, 1, NULL, 'BASE_GAME', 0),
(2, 'Reference Wrestler 2', 14, 3, 14, 3, 14, TIMESTAMP '2026-09-26 00:48:31.588992', FALSE, 'FEMALE', NULL, NULL, NULL, TRUE, 1, 1, 1, 1, NULL, 'BASE_GAME', 0);         
...
CREATE CACHED TABLE "PUBLIC"."ACHIEVEMENT"(
    ...
    "LAST_SYNC" TIMESTAMP,
    "EXPANSION_CODE" CHARACTER VARYING(50) DEFAULT 'BASE_GAME' NOT NULL,
    "UNLOCK_CONDITION" CHARACTER VARYING(2000)
); 
...
CREATE CACHED TABLE "PUBLIC"."ACCOUNT_CHALLENGE_COMPLETION"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "ACCOUNT_ID" BIGINT NOT NULL,
    "CHALLENGE_ID" CHARACTER VARYING(255) NOT NULL,
    "STATUS" CHARACTER VARYING(50) NOT NULL,
    "COMPLETED_AT" TIMESTAMP,
    "PLAYER_NOTES" CHARACTER LARGE OBJECT,
    "PROOF_IMAGE_URL" CHARACTER VARYING(500)
);              
ALTER TABLE "PUBLIC"."ACCOUNT_CHALLENGE_COMPLETION" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_4E" PRIMARY KEY("ID"); 
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.ACCOUNT_CHALLENGE_COMPLETION;             
...
CREATE CACHED TABLE "PUBLIC"."RIVALRY"(
    ...
    "PLE_RESOLUTION_ATTEMPTS" INTEGER DEFAULT 0 NOT NULL,
    "LAST_PLE_RESOLUTION_SHOW_ID" BIGINT
);  
...
CREATE CACHED TABLE "PUBLIC"."WRESTLER_STATE_HISTORY"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "WRESTLER_ID" BIGINT NOT NULL,
    "UNIVERSE_ID" BIGINT NOT NULL,
...
ALTER TABLE "PUBLIC"."WRESTLER_STATE_HISTORY" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_6B7" PRIMARY KEY("ID");      
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WRESTLER_STATE_HISTORY;   
CREATE INDEX "PUBLIC"."IDX_WSH_LOOKUP" ON "PUBLIC"."WRESTLER_STATE_HISTORY"("WRESTLER_ID" NULLS FIRST, "UNIVERSE_ID" NULLS FIRST, "RECORDED_AT" NULLS FIRST);  
...
(1, 'Default Universe', 'GLOBAL', TIMESTAMP '2026-09-26 00:48:30.886587');              
CREATE CACHED TABLE "PUBLIC"."WRESTLER_TITLE_COOLDOWN"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "WRESTLER_STATE_ID" BIGINT NOT NULL,
    "TITLE_ID" BIGINT NOT NULL,
    "DEFENSE_COUNT_AT_CHALLENGE" BIGINT DEFAULT 0 NOT NULL
);        
ALTER TABLE "PUBLIC"."WRESTLER_TITLE_COOLDOWN" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_C0" PRIMARY KEY("ID");      
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WRESTLER_TITLE_COOLDOWN;  
...
(1, 1, 'ACTIVE', TIMESTAMP '2026-09-26 00:48:31.591015', NULL, NULL);   
...
CREATE CACHED TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_TITLE"(
    "BEAT_ID" BIGINT NOT NULL,
    "TITLE_ID" BIGINT NOT NULL
);        
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_TITLE" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_AE" PRIMARY KEY("BEAT_ID", "TITLE_ID");      
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FEUD_SCRIPT_BEAT_TITLE;   
CREATE CACHED TABLE "PUBLIC"."TOURNAMENT_SEGMENT_RULE"(
    "TOURNAMENT_ID" BIGINT NOT NULL,
    "SEGMENT_RULE_ID" BIGINT NOT NULL
);          
ALTER TABLE "PUBLIC"."TOURNAMENT_SEGMENT_RULE" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_8A" PRIMARY KEY("TOURNAMENT_ID", "SEGMENT_RULE_ID");        
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TOURNAMENT_SEGMENT_RULE;  
...
(1, 'Reference Event', 'Test drama event', 'BACKSTAGE_INCIDENT', 'NEUTRAL', TIMESTAMP '2026-09-26 00:48:31.590785', TIMESTAMP '2026-09-26 00:48:31.590785', NULL, NULL, FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, NULL);   
...
(1, 1, 1, 1000, 'ROOKIE', 0, 12, 100, 100, 100, NULL, NULL, TIMESTAMP '2026-09-26 00:48:31.589309'),
(2, 2, 1, 500, 'VETERAN', 2, 14, 100, 100, 100, NULL, NULL, TIMESTAMP '2026-09-26 00:48:31.589713');         
...
CREATE CACHED TABLE "PUBLIC"."SEGMENT_RULE"(
    "SEGMENT_RULE_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 4) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "DESCRIPTION" CHARACTER VARYING,
    ...
    "EXPANSION_CODE" CHARACTER VARYING(50) DEFAULT 'BASE_GAME' NOT NULL,
    "RULES_JSON" CHARACTER VARYING,
    "RULES_HASH" CHARACTER VARYING(64),
    "IS_ACTIVE" BOOLEAN DEFAULT TRUE NOT NULL,
    "ALLOWS_REFEREE_STOPPAGE" BOOLEAN DEFAULT TRUE NOT NULL
);         
ALTER TABLE "PUBLIC"."SEGMENT_RULE" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_ABC" PRIMARY KEY("SEGMENT_RULE_ID");   
-- 3 +/- SELECT COUNT(*) FROM PUBLIC.SEGMENT_RULE;             
INSERT INTO "PUBLIC"."SEGMENT_RULE" VALUES
(1, 'Faction Beatdown', 'A non-match segment where one or more wrestlers are attacked by a group', FALSE, TIMESTAMP '2026-09-26 00:48:31.301829', 'NONE', FALSE, 'CUSTOM', NULL, NULL, TRUE, TRUE),
(2, 'GM Office Confrontation', 'A backstage segment where the player confronts management', FALSE, TIMESTAMP '2026-09-26 00:48:31.301829', 'NONE', FALSE, 'CUSTOM', NULL, NULL, TRUE, TRUE),
(3, 'Performance Review', 'A segment where management evaluates the player''s status and results', FALSE, TIMESTAMP '2026-09-26 00:48:31.301829', 'NONE', FALSE, 'CUSTOM', NULL, NULL, TRUE, TRUE);
...
CREATE CACHED TABLE "PUBLIC"."FEUD_SCRIPT"(
    "FEUD_SCRIPT_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "RIVALRY_ID" BIGINT,
    "FEUD_ID" BIGINT,
    "STATUS" CHARACTER VARYING(16) DEFAULT 'ACTIVE' NOT NULL,
    "MAX_PLE_APPEARANCES" INTEGER DEFAULT 3 NOT NULL,
    "CREATED_DATE" TIMESTAMP NOT NULL
);       
ALTER TABLE "PUBLIC"."FEUD_SCRIPT" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_93C" PRIMARY KEY("FEUD_SCRIPT_ID");     
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FEUD_SCRIPT;              
...
CREATE CACHED TABLE "PUBLIC"."SEGMENT"(
    ...
    "TITLE_SKILL_USED" BOOLEAN DEFAULT FALSE NOT NULL,
    "IS_CONTENDER_MATCH" BOOLEAN DEFAULT FALSE NOT NULL
); 
...
CREATE CACHED TABLE "PUBLIC"."TOURNAMENT_ROUND"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "TOURNAMENT_ID" BIGINT NOT NULL,
    "ROUND_NUMBER" INTEGER NOT NULL,
    "ROUND_NAME" CHARACTER VARYING(64) NOT NULL,
    "STATUS" CHARACTER VARYING(16) DEFAULT 'PENDING' NOT NULL,
    "SHOW_ID" BIGINT,
    "SEGMENT_RULE_ID" BIGINT
);      
ALTER TABLE "PUBLIC"."TOURNAMENT_ROUND" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_62D" PRIMARY KEY("ID");            
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TOURNAMENT_ROUND;         
...
(1, 'Test Faction', 'Reference snapshot faction', TRUE, NULL, NULL, NULL, TIMESTAMP '2026-09-26 00:48:31.588455', NULL, 0, NULL, NULL, NULL);            
...
CREATE CACHED TABLE "PUBLIC"."DATA_MIGRATION_HISTORY"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "MIGRATION_ID" CHARACTER VARYING(255) NOT NULL,
    "APP_VERSION" CHARACTER VARYING(100) NOT NULL,
    "EXECUTED_AT" TIMESTAMP NOT NULL,
    "DURATION_MS" BIGINT NOT NULL,
    "STATUS" CHARACTER VARYING(20) NOT NULL
); 
ALTER TABLE "PUBLIC"."DATA_MIGRATION_HISTORY" ADD CONSTRAINT "PUBLIC"."PK_DATA_MIGRATION_HISTORY" PRIMARY KEY("ID");           
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.DATA_MIGRATION_HISTORY;   
CREATE INDEX "PUBLIC"."IDX_DATA_MIGRATION_HISTORY_STATUS" ON "PUBLIC"."DATA_MIGRATION_HISTORY"("STATUS" NULLS FIRST);          
CREATE CACHED TABLE "PUBLIC"."SEASON_AWARD"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "SEASON_ID" BIGINT NOT NULL,
    "WRESTLER_ID" BIGINT NOT NULL,
    "AWARD_TYPE" CHARACTER VARYING(50) NOT NULL,
    "AWARD_VALUE" CHARACTER VARYING(255),
    "AWARDED_AT" TIMESTAMP NOT NULL
);    
ALTER TABLE "PUBLIC"."SEASON_AWARD" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_8B8" PRIMARY KEY("ID");
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SEASON_AWARD;             
CREATE INDEX "PUBLIC"."IDX_SA_SEASON" ON "PUBLIC"."SEASON_AWARD"("SEASON_ID" NULLS FIRST);     
CREATE CACHED TABLE "PUBLIC"."TITLE_REIGN"(
    ...
    "CONSECUTIVE_WEEKLY_DEFENSES" INTEGER DEFAULT 0 NOT NULL
);          
...
CREATE CACHED TABLE "PUBLIC"."WRESTLER_ABILITY"(
    "WRESTLER_ABILITY_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "WRESTLER_ID" BIGINT NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "DESCRIPTION" CHARACTER VARYING,
    "ABILITY_TYPE" CHARACTER VARYING(32) NOT NULL,
    "MAX_USES" INTEGER,
    "TIMING" CHARACTER VARYING(32),
    "CATEGORY" CHARACTER VARYING(32),
    "IS_DEFAULT" BOOLEAN DEFAULT TRUE NOT NULL,
    "UNLOCK_CONDITION" CHARACTER VARYING,
    "SWAP_CONDITION" CHARACTER VARYING,
    "COST_SCRIPT" CHARACTER VARYING,
    "EFFECT_SCRIPT" CHARACTER VARYING
);            
ALTER TABLE "PUBLIC"."WRESTLER_ABILITY" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_25D" PRIMARY KEY("WRESTLER_ABILITY_ID");           
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.WRESTLER_ABILITY;         
...
(1, 'admin', '$2a$10$wKGJ2IuP7HwMP66VaqSdYuqo3S1lcXpl9oqQkTGuLaDYHfbH57hD6', 'admin@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-09-26 00:48:28.762285', TIMESTAMP '2026-09-26 00:48:28.762285', NULL, NULL, 0, 0, 0, NULL),
(2, 'booker', '$2a$10$OrFNvKFkH5s/DvDzd301Me4v9bpIulbPNasymqmaxCqaUM.kVXHEi', 'booker@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-09-26 00:48:28.762285', TIMESTAMP '2026-09-26 00:48:28.762285', NULL, NULL, 0, 0, 0, NULL),
(3, 'player', '$2a$10$oHciydemMfshOLiGK7g4KO.Epu07svrzinu7PFvdJws5PYK3pIKx.', 'player@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-09-26 00:48:28.762285', TIMESTAMP '2026-09-26 00:48:28.762285', NULL, NULL, 0, 0, 0, NULL),
(4, 'viewer', '$2a$10$no8XHshPMFd14eBxIs9e2uYW8bXm/pT6MOZsXnw.RHyhmRWgvok06', 'viewer@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-09-26 00:48:28.762285', TIMESTAMP '2026-09-26 00:48:28.762285', NULL, NULL, 0, 0, 0, NULL);            
...
CREATE CACHED TABLE "PUBLIC"."SEGMENT_PARTICIPANT"(
    ...
    "FINAL_MOMENTUM" INTEGER,
    "FINAL_HEALTH" INTEGER,
    "FINAL_STAMINA" INTEGER,
    "FINISH_TYPE" CHARACTER VARYING(20),
    "WINNING_CARD_NAME" CHARACTER VARYING(255),
    "CARDS_PLAYED" CHARACTER VARYING,
    "ABILITIES_USED" CHARACTER VARYING(2000)
); 
...
CREATE CACHED TABLE "PUBLIC"."SHOW_SEGMENT_RESERVATION"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "SHOW_ID" BIGINT NOT NULL,
...
ALTER TABLE "PUBLIC"."SHOW_SEGMENT_RESERVATION" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_7F" PRIMARY KEY("ID");     
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SHOW_SEGMENT_RESERVATION; 
...
(1, 1, 1, 'MEMBER', TIMESTAMP '2026-09-26 00:48:30.900136'),
(2, 1, 2, 'MEMBER', TIMESTAMP '2026-09-26 00:48:30.900136'),
(3, 1, 3, 'MEMBER', TIMESTAMP '2026-09-26 00:48:30.900136'),
(4, 1, 4, 'MEMBER', TIMESTAMP '2026-09-26 00:48:30.900136');             
...
CREATE CACHED TABLE "PUBLIC"."TOURNAMENT"(
    "TOURNAMENT_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "NAME" CHARACTER VARYING(255) NOT NULL,
    "FORMAT_ID" CHARACTER VARYING(64) NOT NULL,
    "STATUS" CHARACTER VARYING(16) DEFAULT 'SCHEDULED' NOT NULL,
    "UNIVERSE_ID" BIGINT,
    "TITLE_ID" BIGINT,
    "START_DATE" DATE,
    "END_DATE" DATE,
    "PAYOFF_SHOW_ID" BIGINT,
    "PAYOFF_SEGMENT_TYPE_ID" BIGINT,
    "PAYOFF_SEGMENT_RULE_ID" BIGINT,
    "CODE" CHARACTER VARYING(64),
    "DEFAULT_ENTRANT_COUNT" INTEGER,
    "PARENT_TOURNAMENT_ID" BIGINT,
    "EDITION_ORDINAL" INTEGER,
    "RECURRENCE" CHARACTER VARYING(16) DEFAULT 'NONE' NOT NULL,
    "QUALIFIER_GROUP_SIZE" INTEGER
); 
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_E1" PRIMARY KEY("TOURNAMENT_ID");        
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TOURNAMENT;               
CREATE UNIQUE NULLS DISTINCT INDEX "PUBLIC"."UX_TOURNAMENT_CODE" ON "PUBLIC"."TOURNAMENT"("CODE" NULLS FIRST); 
CREATE INDEX "PUBLIC"."IDX_TOURNAMENT_PARENT" ON "PUBLIC"."TOURNAMENT"("PARENT_TOURNAMENT_ID" NULLS FIRST);    
...
CREATE CACHED TABLE "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "MATCH_ID" BIGINT NOT NULL,
    "ENTRY_ID" BIGINT NOT NULL,
    "SLOT" INTEGER NOT NULL
);           
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_E5" PRIMARY KEY("ID"); 
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TOURNAMENT_MATCH_PARTICIPANT;             
CREATE INDEX "PUBLIC"."IDX_TMP_MATCH" ON "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT"("MATCH_ID" NULLS FIRST);      
...
CREATE CACHED TABLE "PUBLIC"."TOURNAMENT_ENTRY"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "TOURNAMENT_ID" BIGINT NOT NULL,
    "WRESTLER_ID" BIGINT NOT NULL,
...
ALTER TABLE "PUBLIC"."TOURNAMENT_ENTRY" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_62" PRIMARY KEY("ID");             
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TOURNAMENT_ENTRY;         
CREATE CACHED TABLE "PUBLIC"."FEUD_SCRIPT_BEAT"(
    "FEUD_SCRIPT_BEAT_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "SCRIPT_ID" BIGINT NOT NULL,
    "BEAT_ORDER" INTEGER NOT NULL,
    "SEGMENT_TYPE" CHARACTER VARYING(128) NOT NULL,
    "SEGMENT_RULE" CHARACTER VARYING(128),
    "TARGET_SHOW_ID" BIGINT,
    "RESERVATION_ID" BIGINT,
    "WINNER_CONTROL" CHARACTER VARYING(16) DEFAULT 'AI_PICKS' NOT NULL,
    "PLANNED_WINNER_ID" BIGINT,
    "IS_CULMINATION" BOOLEAN DEFAULT FALSE NOT NULL,
    "NOTES" CHARACTER VARYING(255),
    "ACTUAL_SEGMENT_ID" BIGINT,
    "BEAT_STATUS" CHARACTER VARYING(16) DEFAULT 'PENDING' NOT NULL,
    "CONTENDER_TITLE_ID" BIGINT,
    "IS_TITLE_SEGMENT" BOOLEAN DEFAULT FALSE NOT NULL
);         
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_89" PRIMARY KEY("FEUD_SCRIPT_BEAT_ID");            
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FEUD_SCRIPT_BEAT;         
CREATE CACHED TABLE "PUBLIC"."TITLE"(
    ...
    "EXPANSION_CODE" CHARACTER VARYING(50) DEFAULT 'BASE_GAME' NOT NULL,
    "DEFENSE_COUNT" BIGINT DEFAULT 0 NOT NULL
);             
...
(1, 'Reference Championship', NULL, NULL, NULL, TRUE, TIMESTAMP '2026-09-26 00:48:31.590072', 'SINGLE', TRUE, NULL, NULL, NULL, NULL, 'BASE_GAME', 0);     
CREATE CACHED TABLE "PUBLIC"."TOURNAMENT_MATCH"(
    "ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_628" PRIMARY KEY("ID");            
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.TOURNAMENT_MATCH;         
CREATE CACHED TABLE "PUBLIC"."WRESTLING_SHOW"(
    ...
    "BOOKING_MODE" CHARACTER VARYING(50) DEFAULT 'STANDARD' NOT NULL
); 
...
(1, 'Reference Show', NULL, NULL, 1, NULL, NULL, TIMESTAMP '2026-09-26 00:48:31.590533', NULL, NULL, NULL, 0, 0.00, NULL, NULL, 'STANDARD');      
CREATE CACHED TABLE "PUBLIC"."SEGMENT_TYPE"(
    ...
    "CREATION_DATE" TIMESTAMP NOT NULL,
    "EXPANSION_CODE" CHARACTER VARYING(50) DEFAULT 'BASE_GAME' NOT NULL,
    "GUIDE_JSON" CHARACTER VARYING,
    "GUIDE_HASH" CHARACTER VARYING(64),
    "IS_ACTIVE" BOOLEAN DEFAULT TRUE NOT NULL,
    "CODE" CHARACTER VARYING(64),
...
(1, 'Match', NULL, TIMESTAMP '2026-09-26 00:48:31.591327', 'BASE_GAME', NULL, NULL, TRUE, NULL, FALSE);             
CREATE CACHED TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_PARTICIPANT"(
    "FEUD_SCRIPT_BEAT_PARTICIPANT_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL,
    "BEAT_ID" BIGINT NOT NULL,
    "WRESTLER_ID" BIGINT NOT NULL,
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_1CF" PRIMARY KEY("FEUD_SCRIPT_BEAT_PARTICIPANT_ID");   
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.FEUD_SCRIPT_BEAT_PARTICIPANT;             
CREATE CACHED TABLE "PUBLIC"."SHOW_TEMPLATE_ASSIGNMENT_RULE"(
    "ASSIGNMENT_ID" BIGINT NOT NULL,
    "SEGMENT_RULE_ID" BIGINT NOT NULL,
    "POSITION" INTEGER DEFAULT 0 NOT NULL
);         
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_ASSIGNMENT_RULE" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_1A" PRIMARY KEY("ASSIGNMENT_ID", "SEGMENT_RULE_ID");  
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SHOW_TEMPLATE_ASSIGNMENT_RULE;            
CREATE CACHED TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT"(
    ...
    "SPEC_FORMAT_ID" CHARACTER VARYING(64),
    "SPEC_ENTRANT_COUNT" INTEGER,
    "SPEC_FINAL_RULE_ID" BIGINT,
    "SPEC_TITLE_ID" BIGINT
);              
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_468" PRIMARY KEY("ASSIGNMENT_ID"); 
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SHOW_TEMPLATE_SEGMENT_ASSIGNMENT;         
CREATE CACHED TABLE "PUBLIC"."SHOW_TEMPLATE_REQUIRED_EXPANSION"(
    "TEMPLATE_ID" BIGINT NOT NULL,
    "EXPANSION_CODE" CHARACTER VARYING(64) NOT NULL
);     
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_REQUIRED_EXPANSION" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_2EC" PRIMARY KEY("TEMPLATE_ID", "EXPANSION_CODE"); 
-- 0 +/- SELECT COUNT(*) FROM PUBLIC.SHOW_TEMPLATE_REQUIRED_EXPANSION;         
...
ALTER TABLE "PUBLIC"."WRESTLER_TITLE_COOLDOWN" ADD CONSTRAINT "PUBLIC"."UQ_WTC_STATE_TITLE" UNIQUE NULLS DISTINCT ("WRESTLER_STATE_ID", "TITLE_ID");           
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."UQ_TMP_MATCH_SLOT" UNIQUE NULLS DISTINCT ("MATCH_ID", "SLOT");    
...
ALTER TABLE "PUBLIC"."DATA_MIGRATION_HISTORY" ADD CONSTRAINT "PUBLIC"."UQ_DATA_MIGRATION_HISTORY_MIGRATION_ID" UNIQUE NULLS DISTINCT ("MIGRATION_ID");         
...
ALTER TABLE "PUBLIC"."ACCOUNT_CHALLENGE_COMPLETION" ADD CONSTRAINT "PUBLIC"."UQ_ACC_CHALLENGE" UNIQUE NULLS DISTINCT ("ACCOUNT_ID", "CHALLENGE_ID");           
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."UQ_MATCH_SEGMENT" UNIQUE NULLS DISTINCT ("SEGMENT_ID");       
...
ALTER TABLE "PUBLIC"."SHOW_SEGMENT_RESERVATION" ADD CONSTRAINT "PUBLIC"."UQ_SSR_SEGMENT" UNIQUE NULLS DISTINCT ("SEGMENT_ID"); 
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."UQ_FSBP_BEAT_WRESTLER" UNIQUE NULLS DISTINCT ("BEAT_ID", "WRESTLER_ID");          
...
ALTER TABLE "PUBLIC"."SEGMENT_TYPE" ADD CONSTRAINT "PUBLIC"."UQ_SEGMENT_TYPE_CODE" UNIQUE NULLS DISTINCT ("CODE");             
...
ALTER TABLE "PUBLIC"."WRESTLER_ABILITY" ADD CONSTRAINT "PUBLIC"."UQ_WA_WRESTLER_NAME" UNIQUE NULLS DISTINCT ("WRESTLER_ID", "NAME");           
...
ALTER TABLE "PUBLIC"."SHOW_SEGMENT_RESERVATION" ADD CONSTRAINT "PUBLIC"."UQ_SSR_SOURCE" UNIQUE NULLS DISTINCT ("SHOW_ID", "PURPOSE", "SOURCE_ID");             
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."UQ_TMP_MATCH_ENTRY" UNIQUE NULLS DISTINCT ("MATCH_ID", "ENTRY_ID");               
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."FK_MATCH_SEGMENT" FOREIGN KEY("SEGMENT_ID") REFERENCES "PUBLIC"."SEGMENT"("SEGMENT_ID") NOCHECK;              
ALTER TABLE "PUBLIC"."TEAM" ADD CONSTRAINT "PUBLIC"."FK_TEAM_MANAGER" FOREIGN KEY("MANAGER_ID") REFERENCES "PUBLIC"."NPC"("ID") NOCHECK;       
ALTER TABLE "PUBLIC"."SHOW_SEGMENT_RESERVATION" ADD CONSTRAINT "PUBLIC"."FK_SSR_SHOW" FOREIGN KEY("SHOW_ID") REFERENCES "PUBLIC"."WRESTLING_SHOW"("SHOW_ID") NOCHECK;          
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."FK_TMP_ENTRY" FOREIGN KEY("ENTRY_ID") REFERENCES "PUBLIC"."TOURNAMENT_ENTRY"("ID") NOCHECK;       
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."FK_FSB_SCRIPT" FOREIGN KEY("SCRIPT_ID") REFERENCES "PUBLIC"."FEUD_SCRIPT"("FEUD_SCRIPT_ID") ON DELETE CASCADE NOCHECK;        
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."FK_TOURNAMENT_UNIVERSE" FOREIGN KEY("UNIVERSE_ID") REFERENCES "PUBLIC"."UNIVERSE"("ID") NOCHECK;    
...
ALTER TABLE "PUBLIC"."SEASON_AWARD" ADD CONSTRAINT "PUBLIC"."FK_SA_WRESTLER" FOREIGN KEY("WRESTLER_ID") REFERENCES "PUBLIC"."WRESTLER"("WRESTLER_ID") NOCHECK; 
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_ASSIGNMENT_RULE" ADD CONSTRAINT "PUBLIC"."FK_STAR_SEGMENT_RULE" FOREIGN KEY("SEGMENT_RULE_ID") REFERENCES "PUBLIC"."SEGMENT_RULE"("SEGMENT_RULE_ID") NOCHECK;              
...
ALTER TABLE "PUBLIC"."TOURNAMENT_SEGMENT_RULE" ADD CONSTRAINT "PUBLIC"."FK_TSR_SEGMENT_RULE" FOREIGN KEY("SEGMENT_RULE_ID") REFERENCES "PUBLIC"."SEGMENT_RULE"("SEGMENT_RULE_ID") NOCHECK;     
...
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."FK_TOURNAMENT_PARENT" FOREIGN KEY("PARENT_TOURNAMENT_ID") REFERENCES "PUBLIC"."TOURNAMENT"("TOURNAMENT_ID") NOCHECK;
...
ALTER TABLE "PUBLIC"."ACCOUNT_CHALLENGE_COMPLETION" ADD CONSTRAINT "PUBLIC"."FK_ACC_CHALLENGE_ACCOUNT" FOREIGN KEY("ACCOUNT_ID") REFERENCES "PUBLIC"."ACCOUNT"("ID") NOCHECK;  
...
ALTER TABLE "PUBLIC"."TOURNAMENT_ROUND" ADD CONSTRAINT "PUBLIC"."FK_ROUND_TOURNAMENT" FOREIGN KEY("TOURNAMENT_ID") REFERENCES "PUBLIC"."TOURNAMENT"("TOURNAMENT_ID") NOCHECK;  
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."FK_FSBP_BEAT" FOREIGN KEY("BEAT_ID") REFERENCES "PUBLIC"."FEUD_SCRIPT_BEAT"("FEUD_SCRIPT_BEAT_ID") ON DELETE CASCADE NOCHECK;     
...
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."FK_STA_SPEC_TITLE" FOREIGN KEY("SPEC_TITLE_ID") REFERENCES "PUBLIC"."TITLE"("TITLE_ID") NOCHECK;              
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."FK_FSB_WINNER" FOREIGN KEY("PLANNED_WINNER_ID") REFERENCES "PUBLIC"."WRESTLER"("WRESTLER_ID") ON DELETE SET NULL NOCHECK;     
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_TITLE" ADD CONSTRAINT "PUBLIC"."FK_FSBT_BEAT" FOREIGN KEY("BEAT_ID") REFERENCES "PUBLIC"."FEUD_SCRIPT_BEAT"("FEUD_SCRIPT_BEAT_ID") ON DELETE CASCADE NOCHECK;           
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."FK_MATCH_ROUND" FOREIGN KEY("ROUND_ID") REFERENCES "PUBLIC"."TOURNAMENT_ROUND"("ID") NOCHECK; 
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."FK_STA_SEGMENT_RULE" FOREIGN KEY("SEGMENT_RULE_ID") REFERENCES "PUBLIC"."SEGMENT_RULE"("SEGMENT_RULE_ID") NOCHECK;            
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."FK_FSBP_WRESTLER" FOREIGN KEY("WRESTLER_ID") REFERENCES "PUBLIC"."WRESTLER"("WRESTLER_ID") ON DELETE CASCADE NOCHECK;             
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."FK_STA_SEGMENT_TYPE" FOREIGN KEY("SEGMENT_TYPE_ID") REFERENCES "PUBLIC"."SEGMENT_TYPE"("SEGMENT_TYPE_ID") NOCHECK;            
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."FK_TOURNAMENT_PAYOFF_TYPE" FOREIGN KEY("PAYOFF_SEGMENT_TYPE_ID") REFERENCES "PUBLIC"."SEGMENT_TYPE"("SEGMENT_TYPE_ID") NOCHECK;     
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT" ADD CONSTRAINT "PUBLIC"."FK_FS_RIVALRY" FOREIGN KEY("RIVALRY_ID") REFERENCES "PUBLIC"."RIVALRY"("RIVALRY_ID") ON DELETE SET NULL NOCHECK;   
...
ALTER TABLE "PUBLIC"."SEASON_AWARD" ADD CONSTRAINT "PUBLIC"."FK_SA_SEASON" FOREIGN KEY("SEASON_ID") REFERENCES "PUBLIC"."SEASON"("SEASON_ID") NOCHECK;         
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT" ADD CONSTRAINT "PUBLIC"."FK_FS_FEUD" FOREIGN KEY("FEUD_ID") REFERENCES "PUBLIC"."MULTI_WRESTLER_FEUD"("MULTI_WRESTLER_FEUD_ID") ON DELETE SET NULL NOCHECK; 
...
ALTER TABLE "PUBLIC"."WRESTLER_STATE_HISTORY" ADD CONSTRAINT "PUBLIC"."FK_WSH_UNIVERSE" FOREIGN KEY("UNIVERSE_ID") REFERENCES "PUBLIC"."UNIVERSE"("ID") NOCHECK;               
ALTER TABLE "PUBLIC"."TOURNAMENT_ENTRY" ADD CONSTRAINT "PUBLIC"."FK_ENTRY_WRESTLER" FOREIGN KEY("WRESTLER_ID") REFERENCES "PUBLIC"."WRESTLER"("WRESTLER_ID") NOCHECK;          
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH_PARTICIPANT" ADD CONSTRAINT "PUBLIC"."FK_TMP_MATCH" FOREIGN KEY("MATCH_ID") REFERENCES "PUBLIC"."TOURNAMENT_MATCH"("ID") ON DELETE CASCADE NOCHECK;     
ALTER TABLE "PUBLIC"."INBOX_ITEM" ADD CONSTRAINT "PUBLIC"."FK_INBOX_SENDER" FOREIGN KEY("SENDER_ACCOUNT_ID") REFERENCES "PUBLIC"."ACCOUNT"("ID") ON DELETE SET NULL NOCHECK;   
...
ALTER TABLE "PUBLIC"."WRESTLER_TITLE_COOLDOWN" ADD CONSTRAINT "PUBLIC"."FK_WTC_WRESTLER_STATE" FOREIGN KEY("WRESTLER_STATE_ID") REFERENCES "PUBLIC"."WRESTLER_STATE"("ID") ON DELETE CASCADE NOCHECK;          
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."FK_MATCH_WINNER" FOREIGN KEY("WINNER_ENTRY_ID") REFERENCES "PUBLIC"."TOURNAMENT_ENTRY"("ID") NOCHECK;         
...
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."FK_STA_TEMPLATE" FOREIGN KEY("TEMPLATE_ID") REFERENCES "PUBLIC"."SHOW_TEMPLATE"("TEMPLATE_ID") NOCHECK;       
...
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."FK_STA_SPEC_FINAL_RULE" FOREIGN KEY("SPEC_FINAL_RULE_ID") REFERENCES "PUBLIC"."SEGMENT_RULE"("SEGMENT_RULE_ID") NOCHECK;      
ALTER TABLE "PUBLIC"."TOURNAMENT_ENTRY" ADD CONSTRAINT "PUBLIC"."FK_ENTRY_TOURNAMENT" FOREIGN KEY("TOURNAMENT_ID") REFERENCES "PUBLIC"."TOURNAMENT"("TOURNAMENT_ID") NOCHECK;  
...
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT" ADD CONSTRAINT "PUBLIC"."FK_STA_TOURNAMENT" FOREIGN KEY("TOURNAMENT_ID") REFERENCES "PUBLIC"."TOURNAMENT"("TOURNAMENT_ID") NOCHECK;    
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."FK_MATCH_ENTRANT2" FOREIGN KEY("ENTRANT2_ID") REFERENCES "PUBLIC"."TOURNAMENT_ENTRY"("ID") NOCHECK;           
...
ALTER TABLE "PUBLIC"."TOURNAMENT_MATCH" ADD CONSTRAINT "PUBLIC"."FK_MATCH_ENTRANT1" FOREIGN KEY("ENTRANT1_ID") REFERENCES "PUBLIC"."TOURNAMENT_ENTRY"("ID") NOCHECK;           
...
ALTER TABLE "PUBLIC"."TOURNAMENT_ROUND" ADD CONSTRAINT "PUBLIC"."FK_ROUND_SHOW" FOREIGN KEY("SHOW_ID") REFERENCES "PUBLIC"."WRESTLING_SHOW"("SHOW_ID") NOCHECK;
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."FK_TOURNAMENT_PAYOFF_SHOW" FOREIGN KEY("PAYOFF_SHOW_ID") REFERENCES "PUBLIC"."WRESTLING_SHOW"("SHOW_ID") NOCHECK;   
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."FK_TOURNAMENT_PAYOFF_RULE" FOREIGN KEY("PAYOFF_SEGMENT_RULE_ID") REFERENCES "PUBLIC"."SEGMENT_RULE"("SEGMENT_RULE_ID") NOCHECK;     
...
ALTER TABLE "PUBLIC"."WRESTLER_STATE_HISTORY" ADD CONSTRAINT "PUBLIC"."FK_WSH_WRESTLER" FOREIGN KEY("WRESTLER_ID") REFERENCES "PUBLIC"."WRESTLER"("WRESTLER_ID") NOCHECK;      
ALTER TABLE "PUBLIC"."TOURNAMENT_ROUND" ADD CONSTRAINT "PUBLIC"."FK_TR_SEGMENT_RULE" FOREIGN KEY("SEGMENT_RULE_ID") REFERENCES "PUBLIC"."SEGMENT_RULE"("SEGMENT_RULE_ID") NOCHECK;             
...
ALTER TABLE "PUBLIC"."TOURNAMENT_SEGMENT_RULE" ADD CONSTRAINT "PUBLIC"."FK_TSR_TOURNAMENT" FOREIGN KEY("TOURNAMENT_ID") REFERENCES "PUBLIC"."TOURNAMENT"("TOURNAMENT_ID") ON DELETE CASCADE NOCHECK;           
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."FK_FSB_RESERVATION" FOREIGN KEY("RESERVATION_ID") REFERENCES "PUBLIC"."SHOW_SEGMENT_RESERVATION"("ID") ON DELETE SET NULL NOCHECK;            
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."FK_FSB_SHOW" FOREIGN KEY("TARGET_SHOW_ID") REFERENCES "PUBLIC"."WRESTLING_SHOW"("SHOW_ID") ON DELETE SET NULL NOCHECK;        
...
ALTER TABLE "PUBLIC"."SHOW_SEGMENT_RESERVATION" ADD CONSTRAINT "PUBLIC"."FK_SSR_SEGMENT" FOREIGN KEY("SEGMENT_ID") REFERENCES "PUBLIC"."SEGMENT"("SEGMENT_ID") NOCHECK;        
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_REQUIRED_EXPANSION" ADD CONSTRAINT "PUBLIC"."FK_STRE_TEMPLATE" FOREIGN KEY("TEMPLATE_ID") REFERENCES "PUBLIC"."SHOW_TEMPLATE"("TEMPLATE_ID") ON DELETE CASCADE NOCHECK;    
...
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."FK_FSB_SEGMENT" FOREIGN KEY("ACTUAL_SEGMENT_ID") REFERENCES "PUBLIC"."SEGMENT"("SEGMENT_ID") ON DELETE SET NULL NOCHECK;      
...
ALTER TABLE "PUBLIC"."SHOW_TEMPLATE_ASSIGNMENT_RULE" ADD CONSTRAINT "PUBLIC"."FK_STAR_ASSIGNMENT" FOREIGN KEY("ASSIGNMENT_ID") REFERENCES "PUBLIC"."SHOW_TEMPLATE_SEGMENT_ASSIGNMENT"("ASSIGNMENT_ID") ON DELETE CASCADE NOCHECK;              
ALTER TABLE "PUBLIC"."WRESTLER_ABILITY" ADD CONSTRAINT "PUBLIC"."FK_WA_WRESTLER" FOREIGN KEY("WRESTLER_ID") REFERENCES "PUBLIC"."WRESTLER"("WRESTLER_ID") ON DELETE CASCADE NOCHECK;           
...
ALTER TABLE "PUBLIC"."TOURNAMENT" ADD CONSTRAINT "PUBLIC"."FK_TOURNAMENT_TITLE" FOREIGN KEY("TITLE_ID") REFERENCES "PUBLIC"."TITLE"("TITLE_ID") NOCHECK;       
...
ALTER TABLE "PUBLIC"."WRESTLER_TITLE_COOLDOWN" ADD CONSTRAINT "PUBLIC"."FK_WTC_TITLE" FOREIGN KEY("TITLE_ID") REFERENCES "PUBLIC"."TITLE"("TITLE_ID") ON DELETE CASCADE NOCHECK;               
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT" ADD CONSTRAINT "PUBLIC"."FK_FEUD_SCRIPT_BEAT_CONTENDER_TITLE" FOREIGN KEY("CONTENDER_TITLE_ID") REFERENCES "PUBLIC"."TITLE"("TITLE_ID") NOCHECK;       
ALTER TABLE "PUBLIC"."FEUD_SCRIPT_BEAT_TITLE" ADD CONSTRAINT "PUBLIC"."FK_FSBT_TITLE" FOREIGN KEY("TITLE_ID") REFERENCES "PUBLIC"."TITLE"("TITLE_ID") ON DELETE CASCADE NOCHECK;               
