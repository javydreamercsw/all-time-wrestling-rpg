...
;              
CREATE USER IF NOT EXISTS "SA" SALT '5c31c9f20893cedc' HASH 'ce2c2a94a2557877bb1816a3775c1e475d59f3ba1ec297649ee9b64a1a1892ec' ADMIN;          
...
-- 136 +/- SELECT COUNT(*) FROM PUBLIC.flyway_schema_history;  
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(-1, NULL, '<< Flyway Schema History table created >>', 'TABLE', '', NULL, 'SA', TIMESTAMP '2026-08-18 12:26:17.991819', 0, TRUE),
(1, '1', 'Initial Schema', 'SQL', 'V1__Initial_Schema.sql', 1115964703, 'SA', TIMESTAMP '2026-08-18 12:26:18.167533', 107, TRUE),
(2, '2', 'DeckCard SetId', 'SQL', 'V2__DeckCard_SetId.sql', -788503740, 'SA', TIMESTAMP '2026-08-18 12:26:18.197159', 16, TRUE),
(3, '3', 'Add CardSet Name Column', 'SQL', 'V3__Add_CardSet_Name_Column.sql', 118948041, 'SA', TIMESTAMP '2026-08-18 12:26:18.211871', 7, TRUE),
(4, '4', 'Update Card Unique Constraint', 'SQL', 'V4__Update_Card_Unique_Constraint.sql', 659202034, 'SA', TIMESTAMP '2026-08-18 12:26:18.218671', 1, TRUE),
(5, '5', 'Add Adjudication Status To Segment', 'SQL', 'V5__Add_Adjudication_Status_To_Segment.sql', 2134148974, 'SA', TIMESTAMP '2026-08-18 12:26:18.235066', 11, TRUE),
(6, '6', 'Add Segment Order And Main Event', 'SQL', 'V6__Add_Segment_Order_And_Main_Event.sql', 619297846, 'SA', TIMESTAMP '2026-08-18 12:26:18.257431', 17, TRUE),
(7, '7', 'Add Inbox Item Table', 'SQL', 'V7__Add_Inbox_Item_Table.sql', 968071477, 'SA', TIMESTAMP '2026-08-18 12:26:18.264158', 1, TRUE),
(8, '8', 'Add Reference Id To Inbox Item', 'SQL', 'V8__Add_Reference_Id_To_Inbox_Item.sql', 989049951, 'SA', TIMESTAMP '2026-08-18 12:26:18.272348', 3, TRUE),
(9, '9', 'Add Bump Addition To Segment Rule', 'SQL', 'V9__Add_Bump_Addition_To_Segment_Rule.sql', 1037211787, 'SA', TIMESTAMP '2026-08-18 12:26:18.28247', 5, TRUE),
(10, '10', 'Add Image Url To Wrestler', 'SQL', 'V10__Add_Image_Url_To_Wrestler.sql', -1445120071, 'SA', TIMESTAMP '2026-08-18 12:26:18.29949', 12, TRUE),
(11, '11', 'Add Expected Matches And Promos To ShowType', 'SQL', 'V11__Add_Expected_Matches_And_Promos_To_ShowType.sql', -1728232004, 'SA', TIMESTAMP '2026-08-18 12:26:18.313838', 9, TRUE),
(12, '12', 'Add Last Sync To Entities', 'SQL', 'V12__Add_Last_Sync_To_Entities.sql', 1145996377, 'SA', TIMESTAMP '2026-08-18 12:26:18.36103', 42, TRUE),
(13, '13', 'Add External Id And Last Sync To SegmentRule', 'SQL', 'V13__Add_External_Id_And_Last_Sync_To_SegmentRule.sql', -566008599, 'SA', TIMESTAMP '2026-08-18 12:26:18.435087', 68, TRUE),
(14, '14', 'Add External Id And Last Sync To Show Template', 'SQL', 'V14__Add_External_Id_And_Last_Sync_To_Show_Template.sql', -1336096513, 'SA', TIMESTAMP '2026-08-18 12:26:18.443468', 3, TRUE),
(15, '15', 'Add Missing Sync Fields', 'SQL', 'V15__Add_Missing_Sync_Fields.sql', 1365334389, 'SA', TIMESTAMP '2026-08-18 12:26:18.505091', 55, TRUE),
(16, '16', 'Create Tier Boundary Table', 'SQL', 'V16__Create_Tier_Boundary_Table.sql', -1179887120, 'SA', TIMESTAMP '2026-08-18 12:26:18.510879', 1, TRUE),
(17, '18', 'Add Inbox Item Target', 'SQL', 'V18__Add_Inbox_Item_Target.sql', -1149624846, 'SA', TIMESTAMP '2026-08-18 12:26:18.517381', 2, TRUE),
(18, '19', 'Remove Reference Id From Inbox Item', 'SQL', 'V19__Remove_Reference_Id_From_Inbox_Item.sql', -1540103389, 'SA', TIMESTAMP '2026-08-18 12:26:18.523779', 2, TRUE),
(19, '20', 'Create Account Tables', 'SQL', 'V20__Create_Account_Tables.sql', 1011977414, 'SA', TIMESTAMP '2026-08-18 12:26:18.534172', 5, TRUE),
(20, '21', 'Insert Default Accounts', 'SQL', 'V21__Insert_Default_Accounts.sql', -1923279678, 'SA', TIMESTAMP '2026-08-18 12:26:18.549552', 7, TRUE),
(21, '22', 'Add Account To Wrestler', 'SQL', 'V22__Add_Account_To_Wrestler.sql', 76510181, 'SA', TIMESTAMP '2026-08-18 12:26:18.562943', 8, TRUE),
(22, '23', 'Rename feud heat event column', 'SQL', 'V23__Rename_feud_heat_event_column.sql', -497843593, 'SA', TIMESTAMP '2026-08-18 12:26:18.567935', 0, TRUE),
(23, '24', 'Create Game Setting Table', 'SQL', 'V24__Create_Game_Setting_Table.sql', 795307327, 'SA', TIMESTAMP '2026-08-18 12:26:18.572784', 0, TRUE),
(24, '25', 'Create Password Reset Token Table', 'SQL', 'V25__Create_Password_Reset_Token_Table.sql', -332824989, 'SA', TIMESTAMP '2026-08-18 12:26:18.578822', 1, TRUE),
(25, '26', 'Add Championship Type To Title', 'SQL', 'V26__Add_Championship_Type_To_Title.sql', -96901047, 'SA', TIMESTAMP '2026-08-18 12:26:18.586393', 3, TRUE);       
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(26, '27', 'Add AI Settings', 'SQL', 'V27__Add_AI_Settings.sql', 1962182044, 'SA', TIMESTAMP '2026-08-18 12:26:18.591586', 1, TRUE),
(27, '28', 'Add Active To Wrestler', 'SQL', 'V28__Add_Active_To_Wrestler.sql', -338805172, 'SA', TIMESTAMP '2026-08-18 12:26:18.602737', 6, TRUE),
(28, '29', 'Create Holiday Table', 'SQL', 'V29__Create_Holiday_Table.sql', 599478441, 'SA', TIMESTAMP '2026-08-18 12:26:18.608193', 1, TRUE),
(29, '30', 'Populate Holiday Table', 'SQL', 'V30__Populate_Holiday_Table.sql', -1793461912, 'SA', TIMESTAMP '2026-08-18 12:26:18.620157', 3, TRUE),
(30, '31', 'Add Manager To Wrestler And Faction And Team', 'SQL', 'V31__Add_Manager_To_Wrestler_And_Faction_And_Team.sql', 378765621, 'SA', TIMESTAMP '2026-08-18 12:26:18.640686', 16, TRUE),
(31, '32', 'Add Description To Npc', 'SQL', 'V32__Add_Description_To_Npc.sql', 630994349, 'SA', TIMESTAMP '2026-08-18 12:26:18.646342', 2, TRUE),
(32, '33', 'Add Include In Rankings To Title', 'SQL', 'V33__Add_Include_In_Rankings_To_Title.sql', -647497361, 'SA', TIMESTAMP '2026-08-18 12:26:18.65268', 2, TRUE),
(33, '34', 'Add Won At Segment To Title Reign', 'SQL', 'V34__Add_Won_At_Segment_To_Title_Reign.sql', -332785961, 'SA', TIMESTAMP '2026-08-18 12:26:18.659038', 3, TRUE),
(34, '35', 'Rename Show Table', 'SQL', 'V35__Rename_Show_Table.sql', -888951185, 'SA', TIMESTAMP '2026-08-18 12:26:18.66353', 0, TRUE),
(35, '36', 'Add Unique Constraint To Wrestler Account', 'SQL', 'V36__Add_Unique_Constraint_To_Wrestler_Account.sql', -1288629724, 'SA', TIMESTAMP '2026-08-18 12:26:18.66768', 0, TRUE),
(36, '37', 'Create Campaign System', 'SQL', 'V37__Create_Campaign_System.sql', 1504350749, 'SA', TIMESTAMP '2026-08-18 12:26:18.712801', 39, TRUE),
(37, '38', 'Add Theme Preference And Default Setting', 'SQL', 'V38__Add_Theme_Preference_And_Default_Setting.sql', -913225845, 'SA', TIMESTAMP '2026-08-18 12:26:18.720852', 4, TRUE),
(38, '39', 'Add League System', 'SQL', 'V39__Add_League_System.sql', 602764493, 'SA', TIMESTAMP '2026-08-18 12:26:18.753125', 26, TRUE),
(39, '41', 'Add Image Url To Npc', 'SQL', 'V41__Add_Image_Url_To_Npc.sql', -1391881153, 'SA', TIMESTAMP '2026-08-18 12:26:18.75942', 2, TRUE),
(40, '42', 'Add Image Url To Show Template', 'SQL', 'V42__Add_Image_Url_To_Show_Template.sql', 2091528606, 'SA', TIMESTAMP '2026-08-18 12:26:18.765116', 2, TRUE),
(41, '43', 'Add Expected Matches And Promos To ShowTemplate', 'SQL', 'V43__Add_Expected_Matches_And_Promos_To_ShowTemplate.sql', -1363888031, 'SA', TIMESTAMP '2026-08-18 12:26:18.771642', 3, TRUE),
(42, '44', 'Add Recurrence And Defense Frequency', 'SQL', 'V44__Add_Recurrence_And_Defense_Frequency.sql', -33215304, 'SA', TIMESTAMP '2026-08-18 12:26:18.793513', 18, TRUE),
(43, '45', 'Remove LocalAI Settings', 'SQL', 'V45__Remove_LocalAI_Settings.sql', -2084740732, 'SA', TIMESTAMP '2026-08-18 12:26:18.799469', 2, TRUE),
(44, '46', 'Create Commentary Tables', 'SQL', 'V46__Create_Commentary_Tables.sql', 1578209880, 'SA', TIMESTAMP '2026-08-18 12:26:18.823713', 20, TRUE),
(45, '47', 'Create News Tables', 'SQL', 'V47__Create_News_Tables.sql', -2003982983, 'SA', TIMESTAMP '2026-08-18 12:26:18.828181', 1, TRUE),
(46, '48', 'Add Gender Constraint To ShowTemplate', 'SQL', 'V48__Add_Gender_Constraint_To_ShowTemplate.sql', -1162501534, 'SA', TIMESTAMP '2026-08-18 12:26:18.83515', 3, TRUE),
(47, '49', 'Add Legacy Fields To Account', 'SQL', 'V49__Add_Legacy_Fields_To_Account.sql', -508336936, 'SA', TIMESTAMP '2026-08-18 12:26:18.853272', 14, TRUE),
(48, '50', 'Create Achievement Tables', 'SQL', 'V50__Create_Achievement_Tables.sql', 533959700, 'SA', TIMESTAMP '2026-08-18 12:26:18.85985', 2, TRUE),
(49, '51', 'Add Affinity To Faction', 'SQL', 'V51__Add_Affinity_To_Faction.sql', 1676214726, 'SA', TIMESTAMP '2026-08-18 12:26:18.867461', 3, TRUE),
(50, '52', 'Remove Rivalry Unique Constraint', 'SQL', 'V52__Remove_Rivalry_Unique_Constraint.sql', 858104277, 'SA', TIMESTAMP '2026-08-18 12:26:20.13597', 1264, TRUE),
(51, '53', 'Create Storyline Tables', 'SQL', 'V53__Create_Storyline_Tables.sql', 1034900586, 'SA', TIMESTAMP '2026-08-18 12:26:20.152144', 11, TRUE); 
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(52, '54', 'Add Npc Attributes', 'SQL', 'V54__Add_Npc_Attributes.sql', 1944315555, 'SA', TIMESTAMP '2026-08-18 12:26:20.159163', 3, TRUE),
(53, '55', 'Add Referee To Segment', 'SQL', 'V55__Add_Referee_To_Segment.sql', -14042474, 'SA', TIMESTAMP '2026-08-18 12:26:20.170861', 7, TRUE),
(54, '56', 'Add No Dq To Segment Rule', 'SQL', 'V56__Add_No_Dq_To_Segment_Rule.sql', 621834710, 'SA', TIMESTAMP '2026-08-18 12:26:20.176048', 1, TRUE),
(55, '57', 'Add Ringside Actions', 'SQL', 'V57__Add_Ringside_Actions.sql', 551019052, 'SA', TIMESTAMP '2026-08-18 12:26:20.181392', 2, TRUE),
(56, '58', 'Add Physical Condition To Wrestler', 'SQL', 'V58__Add_Physical_Condition_To_Wrestler.sql', -2031017789, 'SA', TIMESTAMP '2026-08-18 12:26:20.18953', 5, TRUE),
(57, '59', 'Create Location Arena Tables And Link Show', 'SQL', 'V59__Create_Location_Arena_Tables_And_Link_Show.sql', -777877363, 'SA', TIMESTAMP '2026-08-18 12:26:20.207905', 14, TRUE),
(58, '60', 'Remove Wrestler Account Unique Constraint', 'SQL', 'V60__Remove_Wrestler_Account_Unique_Constraint.sql', -1366350250, 'SA', TIMESTAMP '2026-08-18 12:26:20.210932', 0, TRUE),
(59, '61', 'Add Faction Alignment And Team Fields', 'SQL', 'V61__Add_Faction_Alignment_And_Team_Fields.sql', -393460592, 'SA', TIMESTAMP '2026-08-18 12:26:20.221229', 8, TRUE),
(60, '62', 'Add Updated At To Entities', 'SQL', 'V62__Add_Updated_At_To_Entities.sql', 588199953, 'SA', TIMESTAMP '2026-08-18 12:26:20.311752', 84, TRUE),
(61, '63', 'Initialize Set Enablement Settings', 'SQL', 'V63__Initialize_Set_Enablement_Settings.sql', 727117897, 'SA', TIMESTAMP '2026-08-18 12:26:20.316741', 1, TRUE),
(62, '64', 'Add Expansion Code To Wrestler', 'SQL', 'V64__Add_Expansion_Code_To_Wrestler.sql', -911082154, 'SA', TIMESTAMP '2026-08-18 12:26:20.325929', 6, TRUE),
(63, '65', 'Add Expansion Code To Npc', 'SQL', 'V65__Add_Expansion_Code_To_Npc.sql', 1736603957, 'SA', TIMESTAMP '2026-08-18 12:26:20.331635', 2, TRUE),
(64, '66', 'Add Image Url To Various Entities', 'SQL', 'V66__Add_Image_Url_To_Various_Entities.sql', 1061733307, 'SA', TIMESTAMP '2026-08-18 12:26:20.342101', 7, TRUE),
(65, '67', 'Create Wrestler Relationship Table', 'SQL', 'V67__Create_Wrestler_Relationship_Table.sql', -401169771, 'SA', TIMESTAMP '2026-08-18 12:26:20.347827', 2, TRUE),
(66, '68', 'Add GM Mode Financials And Logistics', 'SQL', 'V68__Add_GM_Mode_Financials_And_Logistics.sql', 1914270991, 'SA', TIMESTAMP '2026-08-18 12:26:20.381428', 29, TRUE),
(67, '69', 'Add Effect Script To Title', 'SQL', 'V69__Add_Effect_Script_To_Title.sql', 1842801306, 'SA', TIMESTAMP '2026-08-18 12:26:20.3882', 3, TRUE),
(68, '70', 'Add Show Attendance And Revenue', 'SQL', 'V70__Add_Show_Attendance_And_Revenue.sql', 1941232678, 'SA', TIMESTAMP '2026-08-18 12:26:20.398431', 6, TRUE),
(69, '71', 'Add Notes To Segment', 'SQL', 'V71__Add_Notes_To_Segment.sql', 1957484762, 'SA', TIMESTAMP '2026-08-18 12:26:20.40539', 3, TRUE),
(70, '72', 'Create Status Card Tables', 'SQL', 'V72__Create_Status_Card_Tables.sql', -1660610380, 'SA', TIMESTAMP '2026-08-18 12:26:20.413414', 3, TRUE),
(71, '73', 'add campaign ability card constraint', 'SQL', 'V73__add_campaign_ability_card_constraint.sql', 215371348, 'SA', TIMESTAMP '2026-08-18 12:26:20.417', 0, TRUE),
(72, '74', 'Add Team Number To Segment Participant', 'SQL', 'V74__Add_Team_Number_To_Segment_Participant.sql', -1799038452, 'SA', TIMESTAMP '2026-08-18 12:26:20.422767', 2, TRUE),
(73, '75', 'Create Universe Table', 'SQL', 'V75__Create_Universe_Table.sql', 360951789, 'SA', TIMESTAMP '2026-08-18 12:26:20.427631', 1, TRUE),
(74, '76', 'Create Wrestler State Table', 'SQL', 'V76__Create_Wrestler_State_Table.sql', -2083864010, 'SA', TIMESTAMP '2026-08-18 12:26:20.43577', 3, TRUE),
(75, '77', 'Add Universe Membership', 'SQL', 'V77__Add_Universe_Membership.sql', -834416382, 'SA', TIMESTAMP '2026-08-18 12:26:20.440435', 1, TRUE),
(76, '78', 'Add Universe Settings Tables', 'SQL', 'V78__Add_Universe_Settings_Tables.sql', 1718709860, 'SA', TIMESTAMP '2026-08-18 12:26:20.44497', 1, TRUE),
(77, '79', 'Deactivate Same Faction Rivalries', 'SQL', 'V79__Deactivate_Same_Faction_Rivalries.sql', -869186165, 'SA', TIMESTAMP '2026-08-18 12:26:20.451144', 3, TRUE);    
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(78, '80', 'Add RivalryId To Segment', 'SQL', 'V80__Add_RivalryId_To_Segment.sql', 1611206126, 'SA', TIMESTAMP '2026-08-18 12:26:20.455634', 2, TRUE),
(79, '81', 'Decouple Wrestler State', 'SQL', 'V81__Decouple_Wrestler_State.sql', 699881626, 'SA', TIMESTAMP '2026-08-18 12:26:20.478072', 18, TRUE),
(80, '82', 'Drop Deprecated Wrestler Columns', 'SQL', 'V82__Drop_Deprecated_Wrestler_Columns.sql', -479567210, 'SA', TIMESTAMP '2026-08-18 12:26:20.515991', 34, TRUE),
(81, '83', 'Backfill Universe Id', 'SQL', 'V83__Backfill_Universe_Id.sql', -1009108233, 'SA', TIMESTAMP '2026-08-18 12:26:20.520118', 1, TRUE),
(82, '84', 'Add Universe Alignment', 'SQL', 'V84__Add_Universe_Alignment.sql', -1733031706, 'SA', TIMESTAMP '2026-08-18 12:26:20.526031', 2, TRUE),
(83, '85', 'Seed Rivalry Lifecycle Settings', 'SQL', 'V85__Seed_Rivalry_Lifecycle_Settings.sql', 246113347, 'SA', TIMESTAMP '2026-08-18 12:26:20.529437', 0, TRUE),
(84, '86', 'Replace Defense Frequency With Type', 'SQL', 'V86__Replace_Defense_Frequency_With_Type.sql', 2101993557, 'SA', TIMESTAMP '2026-08-18 12:26:20.538058', 5, TRUE),
(85, '87', 'Add Outcome Matrix', 'SQL', 'V87__Add_Outcome_Matrix.sql', 1095930633, 'SA', TIMESTAMP '2026-08-18 12:26:20.544553', 2, TRUE),
(86, '88', 'Add DramaEvent Cleanup Index', 'SQL', 'V88__Add_DramaEvent_Cleanup_Index.sql', 1867476901, 'SA', TIMESTAMP '2026-08-18 12:26:20.548115', 0, TRUE),
(87, '89', 'Link Injury To InjuryType', 'SQL', 'V89__Link_Injury_To_InjuryType.sql', 1285009657, 'SA', TIMESTAMP '2026-08-18 12:26:20.554841', 3, TRUE),
(88, '90', 'Add Wrestler Season Snapshot', 'SQL', 'V90__Add_Wrestler_Season_Snapshot.sql', 710643383, 'SA', TIMESTAMP '2026-08-18 12:26:20.559581', 1, TRUE),
(89, '91', 'Add Universe To Rivalry', 'SQL', 'V91__Add_Universe_To_Rivalry.sql', -1401405617, 'SA', TIMESTAMP '2026-08-18 12:26:20.566036', 4, TRUE),
(90, '92', 'Add Universe Scoped Game Settings', 'SQL', 'V92__Add_Universe_Scoped_Game_Settings.sql', 865269514, 'SA', TIMESTAMP '2026-08-18 12:26:20.573137', 4, TRUE),
(91, '93', 'Migrate Credentials To Default Universe', 'SQL', 'V93__Migrate_Credentials_To_Default_Universe.sql', -1857336965, 'SA', TIMESTAMP '2026-08-18 12:26:20.57737', 1, TRUE),
(92, '94', 'Fix Universe Sequence', 'SQL', 'V94__Fix_Universe_Sequence.sql', -1386687509, 'SA', TIMESTAMP '2026-08-18 12:26:20.582648', 2, TRUE),
(93, '95', 'Create Universe Invite And Join Request Tables', 'SQL', 'V95__Create_Universe_Invite_And_Join_Request_Tables.sql', -1494912489, 'SA', TIMESTAMP '2026-08-18 12:26:20.587915', 1, TRUE),
(94, '96', 'Fix Account FK On Delete Rules', 'SQL', 'V96__Fix_Account_FK_On_Delete_Rules.sql', 1147779210, 'SA', TIMESTAMP '2026-08-18 12:26:20.605679', 8, TRUE),
(95, '97', 'Create Account Tutorial Completion', 'SQL', 'V97__Create_Account_Tutorial_Completion.sql', -558961027, 'SA', TIMESTAMP '2026-08-18 12:26:20.608675', 0, TRUE),
(96, '98', 'Add Current Encounter Id To Campaign State', 'SQL', 'V98__Add_Current_Encounter_Id_To_Campaign_State.sql', 746933968, 'SA', TIMESTAMP '2026-08-18 12:26:20.614645', 3, TRUE),
(97, '99', 'Add Subject To Inbox Item', 'SQL', 'V99__Add_Subject_To_Inbox_Item.sql', 1565727751, 'SA', TIMESTAMP '2026-08-18 12:26:20.618029', 0, TRUE),
(98, '100', 'Add Urgency To Inbox Item', 'SQL', 'V100__Add_Urgency_To_Inbox_Item.sql', 1277308947, 'SA', TIMESTAMP '2026-08-18 12:26:20.621056', 0, TRUE),
(99, '101', 'Add Action Fields To Inbox Item', 'SQL', 'V101__Add_Action_Fields_To_Inbox_Item.sql', 413950941, 'SA', TIMESTAMP '2026-08-18 12:26:20.625556', 1, TRUE),
(100, '102', 'Remove Notion Sync Columns', 'SQL', 'V102__Remove_Notion_Sync_Columns.sql', -1701633824, 'SA', TIMESTAMP '2026-08-18 12:26:20.752631', 120, TRUE),
(101, '103', 'Set Rivalry Resolution Defaults', 'SQL', 'V103__Set_Rivalry_Resolution_Defaults.sql', 182746202, 'SA', TIMESTAMP '2026-08-18 12:26:20.757157', 1, TRUE),
(102, '104', 'Add Expansion Code To Feature Entities', 'SQL', 'V104__Add_Expansion_Code_To_Feature_Entities.sql', 1118552986, 'SA', TIMESTAMP '2026-08-18 12:26:20.765975', 5, TRUE);         
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(103, '105', 'Upgrade Gemini Model Name', 'SQL', 'V105__Upgrade_Gemini_Model_Name.sql', -886320525, 'SA', TIMESTAMP '2026-08-18 12:26:20.768365', 0, TRUE),
(104, '106', 'Add Segment Rule Rules Json', 'SQL', 'V106__Add_Segment_Rule_Rules_Json.sql', 176422839, 'SA', TIMESTAMP '2026-08-18 12:26:20.772301', 1, TRUE),
(105, '107', 'cleanup bogus best friend relationships', 'SQL', 'V107__cleanup_bogus_best_friend_relationships.sql', 1211165419, 'SA', TIMESTAMP '2026-08-18 12:26:20.774699', 0, TRUE),
(106, '108', 'Add Final Momentum To Segment Participant', 'SQL', 'V108__Add_Final_Momentum_To_Segment_Participant.sql', 1898633987, 'SA', TIMESTAMP '2026-08-18 12:26:20.778668', 1, TRUE),
(107, '109', 'Merge Extreme Into No DQ', 'SQL', 'V109__Merge_Extreme_Into_No_DQ.sql', -145341122, 'SA', TIMESTAMP '2026-08-18 12:26:20.781684', 0, TRUE),
(108, '110', 'Add Final Health To Segment Participant', 'SQL', 'V110__Add_Final_Health_To_Segment_Participant.sql', 1552910985, 'SA', TIMESTAMP '2026-08-18 12:26:20.784705', 1, TRUE),
(109, '111', 'Add Guide Json To Segment Type', 'SQL', 'V111__Add_Guide_Json_To_Segment_Type.sql', -1293634829, 'SA', TIMESTAMP '2026-08-18 12:26:20.788312', 1, TRUE),
(110, '112', 'Migrate Campaign Promo Segment Types', 'SQL', 'V112__Migrate_Campaign_Promo_Segment_Types.sql', -23986808, 'SA', TIMESTAMP '2026-08-18 12:26:20.792624', 2, TRUE),
(111, '113', 'Add Is Active To Catalog Entities', 'SQL', 'V113__Add_Is_Active_To_Catalog_Entities.sql', -544962412, 'SA', TIMESTAMP '2026-08-18 12:26:20.802487', 7, TRUE),
(112, '114', 'Drop Injury Is Active Column', 'SQL', 'V114__Drop_Injury_Is_Active_Column.sql', 1001499177, 'SA', TIMESTAMP '2026-08-18 12:26:20.805621', 1, TRUE),
(113, '115', 'Rename Final Momentum To Final Stamina', 'SQL', 'V115__Rename_Final_Momentum_To_Final_Stamina.sql', -335109439, 'SA', TIMESTAMP '2026-08-18 12:26:20.815609', 1, TRUE),
(114, '116', 'Add Title Skill Used To Segment', 'SQL', 'V116__Add_Title_Skill_Used_To_Segment.sql', 1167289880, 'SA', TIMESTAMP '2026-08-18 12:26:20.819691', 1, TRUE),
(115, '117', 'Add Bonus Match Fields To Segment Participant', 'SQL', 'V117__Add_Bonus_Match_Fields_To_Segment_Participant.sql', 2040188674, 'SA', TIMESTAMP '2026-08-18 12:26:20.824388', 3, TRUE),
(116, '118', 'add allows referee stoppage to segment rule', 'SQL', 'V118__add_allows_referee_stoppage_to_segment_rule.sql', -1550473733, 'SA', TIMESTAMP '2026-08-18 12:26:20.827979', 1, TRUE),
(117, '119', 'create account challenge completion', 'SQL', 'V119__create_account_challenge_completion.sql', 114465303, 'SA', TIMESTAMP '2026-08-18 12:26:20.83057', 0, TRUE),
(118, '120', 'add previous last login to account', 'SQL', 'V120__add_previous_last_login_to_account.sql', 1625928857, 'SA', TIMESTAMP '2026-08-18 12:26:20.836641', 3, TRUE),
(119, '121', 'add sender to inbox item', 'SQL', 'V121__add_sender_to_inbox_item.sql', -391355427, 'SA', TIMESTAMP '2026-08-18 12:26:20.840066', 1, TRUE),
(120, '122', 'Add Inbox Retention Setting', 'SQL', 'V122__Add_Inbox_Retention_Setting.sql', -1529445334, 'SA', TIMESTAMP '2026-08-18 12:26:20.843312', 0, TRUE),
(121, '123', 'add quality score to show', 'SQL', 'V123__add_quality_score_to_show.sql', 1409447342, 'SA', TIMESTAMP '2026-08-18 12:26:20.848966', 3, TRUE),
(122, '124', 'add wrestler state history', 'SQL', 'V124__add_wrestler_state_history.sql', 259569851, 'SA', TIMESTAMP '2026-08-18 12:26:20.853597', 1, TRUE),
(123, '125', 'add season award', 'SQL', 'V125__add_season_award.sql', -1782654489, 'SA', TIMESTAMP '2026-08-18 12:26:20.857032', 1, TRUE),
(124, '126', 'add show segment reservation', 'SQL', 'V126__add_show_segment_reservation.sql', 2074824173, 'SA', TIMESTAMP '2026-08-18 12:26:20.860691', 1, TRUE),
(125, '127', 'add tournament', 'SQL', 'V127__add_tournament.sql', 1225194235, 'SA', TIMESTAMP '2026-08-18 12:26:20.867403', 4, TRUE),
(126, '128', 'add booking mode to show', 'SQL', 'V128__add_booking_mode_to_show.sql', 814809843, 'SA', TIMESTAMP '2026-08-18 12:26:20.871841', 2, TRUE),
(127, '129', 'Add Category To ShowType', 'SQL', 'V129__Add_Category_To_ShowType.sql', 1959489143, 'SA', TIMESTAMP '2026-08-18 12:26:20.877077', 2, TRUE);            
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(128, '130', 'Add Unlock Condition To Achievement', 'SQL', 'V130__Add_Unlock_Condition_To_Achievement.sql', 451036812, 'SA', TIMESTAMP '2026-08-18 12:26:20.881183', 1, TRUE),
(129, '131', 'Add Consecutive Weekly Defenses To Title Reign', 'SQL', 'V131__Add_Consecutive_Weekly_Defenses_To_Title_Reign.sql', 62083626, 'SA', TIMESTAMP '2026-08-18 12:26:20.884909', 1, TRUE),
(130, '132', 'Add Consecutive Wins To Wrestler', 'SQL', 'V132__Add_Consecutive_Wins_To_Wrestler.sql', -450298830, 'SA', TIMESTAMP '2026-08-18 12:26:20.890021', 3, TRUE),
(131, '133', 'Add Tournament Segment Rules', 'SQL', 'V133__Add_Tournament_Segment_Rules.sql', -1162541012, 'SA', TIMESTAMP '2026-08-18 12:26:20.895522', 3, TRUE),
(132, '134', 'Add Wrestler Ability', 'SQL', 'V134__Add_Wrestler_Ability.sql', -2005289511, 'SA', TIMESTAMP '2026-08-18 12:26:20.901089', 2, TRUE),
(133, '135', 'Add Unlock Date To Account Achievement', 'SQL', 'V135__Add_Unlock_Date_To_Account_Achievement.sql', -1577363430, 'SA', TIMESTAMP '2026-08-18 12:26:20.905152', 1, TRUE),
(134, '136', 'Add PLE Resolution Attempts To Rivalry', 'SQL', 'V136__Add_PLE_Resolution_Attempts_To_Rivalry.sql', -1976850971, 'SA', TIMESTAMP '2026-08-18 12:26:20.909628', 2, TRUE),
(135, '137', 'Track Last PLE Resolution Show', 'SQL', 'V137__Track_Last_PLE_Resolution_Show.sql', 1288503085, 'SA', TIMESTAMP '2026-08-18 12:26:20.913249', 1, TRUE);     
...
(1, 'Reference Template', NULL, 1, NULL, TIMESTAMP '2026-08-18 12:26:21.023025', NULL, NULL, NULL, 1, 'NONE', NULL, NULL, NULL, NULL, NULL, NULL, TRUE);           
...
(1, 'Match', NULL, TIMESTAMP '2026-08-18 12:26:21.024412', 'BASE_GAME', NULL, NULL, TRUE);          
...
(1, 'Weekly Show', NULL, TIMESTAMP '2026-08-18 12:26:21.022775', 0, 0, TRUE, 'OTHER'); 
...
(1, 'Reference Wrestler', 12, 2, 12, 2, 12, TIMESTAMP '2026-08-18 12:26:21.021295', FALSE, 'MALE', NULL, NULL, NULL, TRUE, 1, 1, 1, 1, NULL, 'BASE_GAME', 0),
(2, 'Reference Wrestler 2', 14, 3, 14, 3, 14, TIMESTAMP '2026-08-18 12:26:21.021475', FALSE, 'FEMALE', NULL, NULL, NULL, TRUE, 1, 1, 1, 1, NULL, 'BASE_GAME', 0);         
...
(1, 'Default Universe', 'GLOBAL', TIMESTAMP '2026-08-18 12:26:20.426786');              
...
(1, 'Reference Championship', NULL, NULL, NULL, TRUE, TIMESTAMP '2026-08-18 12:26:21.022591', 'SINGLE', TRUE, NULL, NULL, NULL, NULL, 'BASE_GAME');        
...
(1, 1, 'ACTIVE', TIMESTAMP '2026-08-18 12:26:21.024036', NULL, NULL);   
...
(1, 'Reference Event', 'Test drama event', 'BACKSTAGE_INCIDENT', 'NEUTRAL', TIMESTAMP '2026-08-18 12:26:21.023772', TIMESTAMP '2026-08-18 12:26:21.023772', NULL, NULL, FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, NULL);   
...
(1, 1, 1, 1000, 'ROOKIE', 0, 12, 100, 100, 100, NULL, NULL, TIMESTAMP '2026-08-18 12:26:21.02179'),
(2, 2, 1, 500, 'VETERAN', 2, 14, 100, 100, 100, NULL, NULL, TIMESTAMP '2026-08-18 12:26:21.022199');          
...
(1, 'Faction Beatdown', 'A non-match segment where one or more wrestlers are attacked by a group', FALSE, TIMESTAMP '2026-08-18 12:26:20.790443', 'NONE', FALSE, 'CUSTOM', NULL, NULL, TRUE, TRUE),
(2, 'GM Office Confrontation', 'A backstage segment where the player confronts management', FALSE, TIMESTAMP '2026-08-18 12:26:20.790443', 'NONE', FALSE, 'CUSTOM', NULL, NULL, TRUE, TRUE),
(3, 'Performance Review', 'A segment where management evaluates the player''s status and results', FALSE, TIMESTAMP '2026-08-18 12:26:20.790443', 'NONE', FALSE, 'CUSTOM', NULL, NULL, TRUE, TRUE);
...
(1, 'Test Faction', 'Reference snapshot faction', TRUE, NULL, NULL, NULL, TIMESTAMP '2026-08-18 12:26:21.020913', NULL, 0, NULL, NULL, NULL);            
...
(1, 'admin', '$2a$10$wKGJ2IuP7HwMP66VaqSdYuqo3S1lcXpl9oqQkTGuLaDYHfbH57hD6', 'admin@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-08-18 12:26:18.543525', TIMESTAMP '2026-08-18 12:26:18.543525', NULL, NULL, 0, 0, 0, NULL),
(2, 'booker', '$2a$10$OrFNvKFkH5s/DvDzd301Me4v9bpIulbPNasymqmaxCqaUM.kVXHEi', 'booker@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-08-18 12:26:18.543525', TIMESTAMP '2026-08-18 12:26:18.543525', NULL, NULL, 0, 0, 0, NULL),
(3, 'player', '$2a$10$oHciydemMfshOLiGK7g4KO.Epu07svrzinu7PFvdJws5PYK3pIKx.', 'player@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-08-18 12:26:18.543525', TIMESTAMP '2026-08-18 12:26:18.543525', NULL, NULL, 0, 0, 0, NULL),
(4, 'viewer', '$2a$10$no8XHshPMFd14eBxIs9e2uYW8bXm/pT6MOZsXnw.RHyhmRWgvok06', 'viewer@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-08-18 12:26:18.543525', TIMESTAMP '2026-08-18 12:26:18.543525', NULL, NULL, 0, 0, 0, NULL);            
...
(1, 1, 1, 'MEMBER', TIMESTAMP '2026-08-18 12:26:20.438955'),
(2, 1, 2, 'MEMBER', TIMESTAMP '2026-08-18 12:26:20.438955'),
(3, 1, 3, 'MEMBER', TIMESTAMP '2026-08-18 12:26:20.438955'),
(4, 1, 4, 'MEMBER', TIMESTAMP '2026-08-18 12:26:20.438955');             
...
(1, 'Reference Show', NULL, NULL, 1, NULL, NULL, TIMESTAMP '2026-08-18 12:26:21.023405', NULL, NULL, NULL, 0, 0.00, NULL, NULL, 'STANDARD');      
