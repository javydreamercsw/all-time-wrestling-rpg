...
CREATE TABLE `account` (
  ...
  `previous_last_login` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `account` VALUES (1,'admin','$2a$10$wKGJ2IuP7HwMP66VaqSdYuqo3S1lcXpl9oqQkTGuLaDYHfbH57hD6','admin@atwrpg.local',1,1,1,1,0,NULL,NULL,'2026-09-26 00:49:38','2026-09-26 00:49:38',NULL,NULL,0,0,0,NULL),(2,'booker','$2a$10$OrFNvKFkH5s/DvDzd301Me4v9bpIulbPNasymqmaxCqaUM.kVXHEi','booker@atwrpg.local',1,1,1,1,0,NULL,NULL,'2026-09-26 00:49:38','2026-09-26 00:49:38',NULL,NULL,0,0,0,NULL),(3,'player','$2a$10$oHciydemMfshOLiGK7g4KO.Epu07svrzinu7PFvdJws5PYK3pIKx.','player@atwrpg.local',1,1,1,1,0,NULL,NULL,'2026-09-26 00:49:38','2026-09-26 00:49:38',NULL,NULL,0,0,0,NULL),(4,'viewer','$2a$10$no8XHshPMFd14eBxIs9e2uYW8bXm/pT6MOZsXnw.RHyhmRWgvok06','viewer@atwrpg.local',1,1,1,1,0,NULL,NULL,'2026-09-26 00:49:38','2026-09-26 00:49:38',NULL,NULL,0,0,0,NULL);
...
--
-- Table structure for table `account_challenge_completion`
--

DROP TABLE IF EXISTS `account_challenge_completion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `account_challenge_completion` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_acc_challenge` (`account_id`,`challenge_id`),
  CONSTRAINT `fk_acc_challenge_account` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `account_challenge_completion`
--

LOCK TABLES `account_challenge_completion` WRITE;
/*!40000 ALTER TABLE `account_challenge_completion` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_challenge_completion` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `account_tutorial_completion`
--

DROP TABLE IF EXISTS `account_tutorial_completion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `account_tutorial_completion` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_atc` (`account_id`,`universe_type`),
  CONSTRAINT `fk_atc_account` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `account_tutorial_completion`
--

LOCK TABLES `account_tutorial_completion` WRITE;
/*!40000 ALTER TABLE `account_tutorial_completion` DISABLE KEYS */;
/*!40000 ALTER TABLE `account_tutorial_completion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `achievement` (
  ...
  `expansion_code` varchar(50) NOT NULL DEFAULT 'BASE_GAME',
  `unlock_condition` varchar(2000) DEFAULT NULL,
...
INSERT INTO `campaign` VALUES (1,1,'ACTIVE','2026-09-26 00:49:49',NULL,1);
...
CREATE TABLE `campaign_state` (
  ...
  `current_encounter_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `data_migration_history`
--

DROP TABLE IF EXISTS `data_migration_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `data_migration_history` (
  ...
  `status` varchar(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_data_migration_history_migration_id` (`migration_id`),
  KEY `idx_data_migration_history_status` (`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `data_migration_history`
--

LOCK TABLES `data_migration_history` WRITE;
/*!40000 ALTER TABLE `data_migration_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `data_migration_history` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `drama_event` VALUES (1,'Reference Event','Test drama event','BACKSTAGE_INCIDENT','NEUTRAL','2026-09-26 00:49:49','2026-09-26 00:49:49',NULL,NULL,0,0,0,0,NULL,NULL,NULL,NULL,1);
...
INSERT INTO `faction` VALUES (1,'Reference Faction','Snapshot seed faction',1,NULL,NULL,NULL,'2026-09-26 00:49:49',NULL,0,NULL,NULL,1);
...
--
-- Table structure for table `feud_script`
--

DROP TABLE IF EXISTS `feud_script`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `feud_script`
--

LOCK TABLES `feud_script` WRITE;
/*!40000 ALTER TABLE `feud_script` DISABLE KEYS */;
/*!40000 ALTER TABLE `feud_script` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `feud_script_beat`
--

DROP TABLE IF EXISTS `feud_script_beat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `feud_script_beat` (
  ...
  `segment_rule` varchar(128) DEFAULT NULL,
  `target_show_id` bigint DEFAULT NULL,
  `reservation_id` bigint DEFAULT NULL,
  `winner_control` varchar(16) NOT NULL DEFAULT 'AI_PICKS',
  `planned_winner_id` bigint DEFAULT NULL,
  `is_culmination` tinyint(1) NOT NULL DEFAULT '0',
  `notes` varchar(255) DEFAULT NULL,
  `actual_segment_id` bigint DEFAULT NULL,
  `beat_status` varchar(16) NOT NULL DEFAULT 'PENDING',
  `contender_title_id` bigint DEFAULT NULL,
  `is_title_segment` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`feud_script_beat_id`),
  KEY `fk_fsb_script` (`script_id`),
  KEY `fk_fsb_show` (`target_show_id`),
  KEY `fk_fsb_reservation` (`reservation_id`),
  KEY `fk_fsb_winner` (`planned_winner_id`),
  KEY `fk_fsb_segment` (`actual_segment_id`),
  KEY `fk_feud_script_beat_contender_title` (`contender_title_id`),
  CONSTRAINT `fk_feud_script_beat_contender_title` FOREIGN KEY (`contender_title_id`) REFERENCES `title` (`title_id`),
...
--
-- Dumping data for table `feud_script_beat`
--

LOCK TABLES `feud_script_beat` WRITE;
/*!40000 ALTER TABLE `feud_script_beat` DISABLE KEYS */;
/*!40000 ALTER TABLE `feud_script_beat` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `feud_script_beat_participant`
--

DROP TABLE IF EXISTS `feud_script_beat_participant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `feud_script_beat_participant` (
  ...
  UNIQUE KEY `uq_fsbp_beat_wrestler` (`beat_id`,`wrestler_id`),
  KEY `fk_fsbp_wrestler` (`wrestler_id`),
...
--
-- Dumping data for table `feud_script_beat_participant`
--

LOCK TABLES `feud_script_beat_participant` WRITE;
/*!40000 ALTER TABLE `feud_script_beat_participant` DISABLE KEYS */;
/*!40000 ALTER TABLE `feud_script_beat_participant` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `feud_script_beat_title`
--

DROP TABLE IF EXISTS `feud_script_beat_title`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `feud_script_beat_title`
--

LOCK TABLES `feud_script_beat_title` WRITE;
/*!40000 ALTER TABLE `feud_script_beat_title` DISABLE KEYS */;
/*!40000 ALTER TABLE `feud_script_beat_title` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `flyway_schema_history` VALUES (1,'1','Initial Schema','SQL','V1__Initial_Schema.sql',-2075464759,'atwrpg','2026-09-26 00:49:38',618,1),(2,'2','Add Won At Segment To Title Reign','SQL','V2__Add_Won_At_Segment_To_Title_Reign.sql',-332785961,'atwrpg','2026-09-26 00:49:38',46,1),(3,'3','Rename Show Table','SQL','V3__Rename_Show_Table.sql',-1147003678,'atwrpg','2026-09-26 00:49:38',22,1),(4,'4','Add Unique Constraint To Wrestler Account','SQL','V4__Add_Unique_Constraint_To_Wrestler_Account.sql',0,'atwrpg','2026-09-26 00:49:38',3,1),(5,'5','Create Campaign System','SQL','V5__Create_Campaign_System.sql',-1212479758,'atwrpg','2026-09-26 00:49:39',483,1),(6,'6','Add Theme Preference And Default Setting','SQL','V6__Add_Theme_Preference_And_Default_Setting.sql',-913225845,'atwrpg','2026-09-26 00:49:39',22,1),(7,'7','Add League System','SQL','V7__Add_League_System.sql',100936296,'atwrpg','2026-09-26 00:49:39',206,1),(8,'9','Add Image Url To Npc','SQL','V9__Add_Image_Url_To_Npc.sql',-1391881153,'atwrpg','2026-09-26 00:49:39',25,1),(9,'10','Add Image Url To Show Template','SQL','V10__Add_Image_Url_To_Show_Template.sql',2091528606,'atwrpg','2026-09-26 00:49:39',19,1),(10,'11','Add Expected Matches And Promos To ShowTemplate','SQL','V11__Add_Expected_Matches_And_Promos_To_ShowTemplate.sql',-1363888031,'atwrpg','2026-09-26 00:49:39',58,1),(11,'12','Add Recurrence And Defense Frequency','SQL','V12__Add_Recurrence_And_Defense_Frequency.sql',-33215304,'atwrpg','2026-09-26 00:49:39',162,1),(12,'13','Remove LocalAI Settings','SQL','V13__Remove_LocalAI_Settings.sql',-2084740732,'atwrpg','2026-09-26 00:49:39',4,1),(13,'14','Create Commentary Tables','SQL','V14__Create_Commentary_Tables.sql',-1829352772,'atwrpg','2026-09-26 00:49:40',229,1),(14,'15','Create News Tables','SQL','V15__Create_News_Tables.sql',-2003982983,'atwrpg','2026-09-26 00:49:40',11,1),(15,'16','Add Gender Constraint To ShowTemplate','SQL','V16__Add_Gender_Constraint_To_ShowTemplate.sql',-1162501534,'atwrpg','2026-09-26 00:49:40',22,1),(16,'17','Add Legacy Fields To Account','SQL','V17__Add_Legacy_Fields_To_Account.sql',-508336936,'atwrpg','2026-09-26 00:49:40',95,1),(17,'18','Create Achievement Tables','SQL','V18__Create_Achievement_Tables.sql',1925586479,'atwrpg','2026-09-26 00:49:40',26,1),(18,'19','Add Affinity To Faction','SQL','V19__Add_Affinity_To_Faction.sql',1676214726,'atwrpg','2026-09-26 00:49:40',28,1),(19,'20','Remove Rivalry Unique Constraint','SQL','V20__Remove_Rivalry_Unique_Constraint.sql',-1313235155,'atwrpg','2026-09-26 00:49:40',26,1),(20,'21','Create Storyline Tables','SQL','V21__Create_Storyline_Tables.sql',-1288453859,'atwrpg','2026-09-26 00:49:40',109,1),(21,'22','Add Npc Attributes','SQL','V22__Add_Npc_Attributes.sql',1944315555,'atwrpg','2026-09-26 00:49:40',26,1),(22,'23','Add Referee To Segment','SQL','V23__Add_Referee_To_Segment.sql',1177591894,'atwrpg','2026-09-26 00:49:40',136,1),(23,'24','Add No Dq To Segment Rule','SQL','V24__Add_No_Dq_To_Segment_Rule.sql',621834710,'atwrpg','2026-09-26 00:49:40',17,1),(24,'25','Add Ringside Actions','SQL','V25__Add_Ringside_Actions.sql',-837106943,'atwrpg','2026-09-26 00:49:40',29,1),(25,'26','Add Physical Condition To Wrestler','SQL','V26__Add_Physical_Condition_To_Wrestler.sql',-2031017789,'atwrpg','2026-09-26 00:49:40',80,1),(26,'27','Create Location Arena Tables And Link Show','SQL','V27__Create_Location_Arena_Tables_And_Link_Show.sql',-282762121,'atwrpg','2026-09-26 00:49:41',259,1),(27,'28','Remove Wrestler Account Unique Constraint','SQL','V28__Remove_Wrestler_Account_Unique_Constraint.sql',-433816961,'atwrpg','2026-09-26 00:49:41',9,1),(28,'29','Add Faction Alignment And Team Fields','SQL','V29__Add_Faction_Alignment_And_Team_Fields.sql',-393460592,'atwrpg','2026-09-26 00:49:41',83,1),(29,'30','Add Updated At To Entities','SQL','V30__Add_Updated_At_To_Entities.sql',-1658631685,'atwrpg','2026-09-26 00:49:42',877,1),(30,'31','Initialize Set Enablement Settings','SQL','V31__Initialize_Set_Enablement_Settings.sql',727117897,'atwrpg','2026-09-26 00:49:42',7,1),(31,'32','Add Expansion Code To Wrestler','SQL','V32__Add_Expansion_Code_To_Wrestler.sql',-911082154,'atwrpg','2026-09-26 00:49:42',67,1),(32,'33','Add Expansion Code To Npc','SQL','V33__Add_Expansion_Code_To_Npc.sql',1736603957,'atwrpg','2026-09-26 00:49:42',30,1),(33,'34','Add Image Url To Various Entities','SQL','V34__Add_Image_Url_To_Various_Entities.sql',-517119444,'atwrpg','2026-09-26 00:49:42',69,1),(34,'35','Create Wrestler Relationship Table','SQL','V35__Create_Wrestler_Relationship_Table.sql',387058247,'atwrpg','2026-09-26 00:49:42',30,1),(35,'36','Add GM Mode Financials And Logistics','SQL','V36__Add_GM_Mode_Financials_And_Logistics.sql',896273371,'atwrpg','2026-09-26 00:49:42',358,1),(36,'37','Add Effect Script To Title','SQL','V37__Add_Effect_Script_To_Title.sql',1842801306,'atwrpg','2026-09-26 00:49:42',24,1),(37,'38','Add Show Attendance And Revenue','SQL','V38__Add_Show_Attendance_And_Revenue.sql',1941232678,'atwrpg','2026-09-26 00:49:42',50,1),(38,'39','Add Notes To Segment','SQL','V39__Add_Notes_To_Segment.sql',1957484762,'atwrpg','2026-09-26 00:49:42',44,1),(39,'40','Create Status Card Tables','SQL','V40__Create_Status_Card_Tables.sql',326802875,'atwrpg','2026-09-26 00:49:43',67,1),(40,'41','add campaign ability card constraint','SQL','V41__add_campaign_ability_card_constraint.sql',-1424910555,'atwrpg','2026-09-26 00:49:43',13,1),(41,'42','Add Team Number To Segment Participant','SQL','V42__Add_Team_Number_To_Segment_Participant.sql',-1799038452,'atwrpg','2026-09-26 00:49:43',17,1),(42,'43','Create Universe Table','SQL','V43__Create_Universe_Table.sql',-2040159274,'atwrpg','2026-09-26 00:49:43',10,1),(43,'44','Create Wrestler State Table','SQL','V44__Create_Wrestler_State_Table.sql',-1904189481,'atwrpg','2026-09-26 00:49:43',31,1),(44,'45','Add Universe Membership','SQL','V45__Add_Universe_Membership.sql',2092049629,'atwrpg','2026-09-26 00:49:43',17,1),(45,'46','Add Universe Settings Tables','SQL','V46__Add_Universe_Settings_Tables.sql',1564362811,'atwrpg','2026-09-26 00:49:43',28,1),(46,'47','Deactivate Same Faction Rivalries','SQL','V47__Deactivate_Same_Faction_Rivalries.sql',-351764884,'atwrpg','2026-09-26 00:49:43',3,1),(47,'48','Add RivalryId To Segment','SQL','V48__Add_RivalryId_To_Segment.sql',1611206126,'atwrpg','2026-09-26 00:49:43',35,1),(48,'49','add campaign ability card constraint idempotent','SQL','V49__add_campaign_ability_card_constraint_idempotent.sql',2027248105,'atwrpg','2026-09-26 00:49:43',24,1),(49,'50','Add Team Number To Segment Participant idempotent','SQL','V50__Add_Team_Number_To_Segment_Participant_idempotent.sql',1618984521,'atwrpg','2026-09-26 00:49:43',4,1),(50,'51','Decouple Wrestler State','SQL','V51__Decouple_Wrestler_State.sql',-369822378,'atwrpg','2026-09-26 00:49:43',349,1),(51,'52','Drop Deprecated Wrestler Columns','SQL','V52__Drop_Deprecated_Wrestler_Columns.sql',-2102293264,'atwrpg','2026-09-26 00:49:44',1035,1),(52,'53','Backfill Universe Id','SQL','V53__Backfill_Universe_Id.sql',-1694769477,'atwrpg','2026-09-26 00:49:44',13,1),(53,'54','Add Universe Alignment','SQL','V54__Add_Universe_Alignment.sql',-1733031706,'atwrpg','2026-09-26 00:49:44',51,1),(54,'55','Seed Rivalry Lifecycle Settings','SQL','V55__Seed_Rivalry_Lifecycle_Settings.sql',-661848111,'atwrpg','2026-09-26 00:49:44',2,1),(55,'56','Replace Defense Frequency With Type','SQL','V56__Replace_Defense_Frequency_With_Type.sql',2101993557,'atwrpg','2026-09-26 00:49:44',58,1),(56,'57','Add Outcome Matrix','SQL','V57__Add_Outcome_Matrix.sql',-1072229307,'atwrpg','2026-09-26 00:49:44',19,1),(57,'58','Add DramaEvent Cleanup Index','SQL','V58__Add_DramaEvent_Cleanup_Index.sql',-1939705152,'atwrpg','2026-09-26 00:49:45',14,1),(58,'59','Link Injury To InjuryType','SQL','V59__Link_Injury_To_InjuryType.sql',-1300595049,'atwrpg','2026-09-26 00:49:45',47,1),(59,'60','Add Wrestler Season Snapshot','SQL','V60__Add_Wrestler_Season_Snapshot.sql',-840879091,'atwrpg','2026-09-26 00:49:45',14,1),(60,'61','Add Universe To Rivalry','SQL','V61__Add_Universe_To_Rivalry.sql',-1158894585,'atwrpg','2026-09-26 00:49:45',55,1),(61,'62','Add Universe Scoped Game Settings','SQL','V62__Add_Universe_Scoped_Game_Settings.sql',1150524815,'atwrpg','2026-09-26 00:49:45',44,1),(62,'63','Migrate Credentials To Default Universe','SQL','V63__Migrate_Credentials_To_Default_Universe.sql',-1857336965,'atwrpg','2026-09-26 00:49:45',6,1),(63,'64','Create Universe Invite And Join Request Tables','SQL','V64__Create_Universe_Invite_And_Join_Request_Tables.sql',-1932337377,'atwrpg','2026-09-26 00:49:45',91,1),(64,'65','Fix Account FK On Delete Rules','SQL','V65__Fix_Account_FK_On_Delete_Rules.sql',559640399,'atwrpg','2026-09-26 00:49:45',122,1),(65,'66','Create Account Tutorial Completion','SQL','V66__Create_Account_Tutorial_Completion.sql',-779619283,'atwrpg','2026-09-26 00:49:45',13,1),(66,'67','Add Current Encounter Id To Campaign State','SQL','V67__Add_Current_Encounter_Id_To_Campaign_State.sql',472519808,'atwrpg','2026-09-26 00:49:45',29,1),(67,'68','Add Subject To Inbox Item','SQL','V68__Add_Subject_To_Inbox_Item.sql',1565727751,'atwrpg','2026-09-26 00:49:45',15,1),(68,'69','Add Urgency To Inbox Item','SQL','V69__Add_Urgency_To_Inbox_Item.sql',1277308947,'atwrpg','2026-09-26 00:49:45',23,1),(69,'70','Add Action Fields To Inbox Item','SQL','V70__Add_Action_Fields_To_Inbox_Item.sql',413950941,'atwrpg','2026-09-26 00:49:45',44,1),(70,'71','Remove Notion Sync Columns','SQL','V71__Remove_Notion_Sync_Columns.sql',1706634065,'atwrpg','2026-09-26 00:49:46',924,1),(71,'72','Set Rivalry Resolution Defaults','SQL','V72__Set_Rivalry_Resolution_Defaults.sql',182746202,'atwrpg','2026-09-26 00:49:46',7,1),(72,'73','Add Expansion Code To Feature Entities','SQL','V73__Add_Expansion_Code_To_Feature_Entities.sql',-171214086,'atwrpg','2026-09-26 00:49:46',115,1),(73,'74','Upgrade Gemini Model Name','SQL','V74__Upgrade_Gemini_Model_Name.sql',-886320525,'atwrpg','2026-09-26 00:49:46',2,1),(74,'75','Add Segment Rule Rules Json','SQL','V75__Add_Segment_Rule_Rules_Json.sql',1666288443,'atwrpg','2026-09-26 00:49:46',37,1),(75,'76','cleanup bogus best friend relationships','SQL','V76__cleanup_bogus_best_friend_relationships.sql',1211165419,'atwrpg','2026-09-26 00:49:46',2,1),(76,'77','Add Final Momentum To Segment Participant','SQL','V77__Add_Final_Momentum_To_Segment_Participant.sql',636642950,'atwrpg','2026-09-26 00:49:46',14,1),(77,'78','Merge Extreme Into No DQ','SQL','V78__Merge_Extreme_Into_No_DQ.sql',-145341122,'atwrpg','2026-09-26 00:49:46',4,1),(78,'79','Add Final Health To Segment Participant','SQL','V79__Add_Final_Health_To_Segment_Participant.sql',1777329725,'atwrpg','2026-09-26 00:49:46',16,1),(79,'80','Add Guide Json To Segment Type','SQL','V80__Add_Guide_Json_To_Segment_Type.sql',-419763198,'atwrpg','2026-09-26 00:49:46',34,1),(80,'81','Migrate Campaign Promo Segment Types','SQL','V81__Migrate_Campaign_Promo_Segment_Types.sql',847420951,'atwrpg','2026-09-26 00:49:47',8,1),(81,'82','Add Is Active To Catalog Entities','SQL','V82__Add_Is_Active_To_Catalog_Entities.sql',42189640,'atwrpg','2026-09-26 00:49:47',141,1),(82,'83','Drop Injury Is Active Column','SQL','V83__Drop_Injury_Is_Active_Column.sql',1785054820,'atwrpg','2026-09-26 00:49:47',18,1),(83,'84','Rename Final Momentum To Final Stamina','SQL','V84__Rename_Final_Momentum_To_Final_Stamina.sql',-2067114074,'atwrpg','2026-09-26 00:49:47',16,1),(84,'85','Add Title Skill Used To Segment','SQL','V85__Add_Title_Skill_Used_To_Segment.sql',-766671693,'atwrpg','2026-09-26 00:49:47',35,1),(85,'86','Add Bonus Match Fields To Segment Participant','SQL','V86__Add_Bonus_Match_Fields_To_Segment_Participant.sql',2040188674,'atwrpg','2026-09-26 00:49:47',68,1),(86,'87','add allows referee stoppage to segment rule','SQL','V87__add_allows_referee_stoppage_to_segment_rule.sql',-1550473733,'atwrpg','2026-09-26 00:49:47',15,1),(87,'88','create account challenge completion','SQL','V88__create_account_challenge_completion.sql',349331085,'atwrpg','2026-09-26 00:49:47',13,1),(88,'89','add previous last login to account','SQL','V89__add_previous_last_login_to_account.sql',-411473713,'atwrpg','2026-09-26 00:49:47',47,1),(89,'90','add sender to inbox item','SQL','V90__add_sender_to_inbox_item.sql',-1001953276,'atwrpg','2026-09-26 00:49:47',25,1),(90,'91','Add Inbox Retention Setting','SQL','V91__Add_Inbox_Retention_Setting.sql',1954080741,'atwrpg','2026-09-26 00:49:47',2,1),(91,'92','add quality score to show','SQL','V92__add_quality_score_to_show.sql',1409447342,'atwrpg','2026-09-26 00:49:47',24,1),(92,'93','add wrestler state history','SQL','V93__add_wrestler_state_history.sql',1697355186,'atwrpg','2026-09-26 00:49:47',14,1),(93,'94','add season award','SQL','V94__add_season_award.sql',-2091984079,'atwrpg','2026-09-26 00:49:47',19,1),(94,'95','add show segment reservation','SQL','V95__add_show_segment_reservation.sql',-180470959,'atwrpg','2026-09-26 00:49:47',27,1),(95,'96','add tournament','SQL','V96__add_tournament.sql',-1186032017,'atwrpg','2026-09-26 00:49:47',61,1),(96,'97','add booking mode to show','SQL','V97__add_booking_mode_to_show.sql',814809843,'atwrpg','2026-09-26 00:49:47',31,1),(97,'98','Add Category To ShowType','SQL','V98__Add_Category_To_ShowType.sql',1763588266,'atwrpg','2026-09-26 00:49:47',39,1),(98,'99','Add Unlock Condition To Achievement','SQL','V99__Add_Unlock_Condition_To_Achievement.sql',-1502175832,'atwrpg','2026-09-26 00:49:47',17,1),(99,'100','Add Consecutive Weekly Defenses To Title Reign','SQL','V100__Add_Consecutive_Weekly_Defenses_To_Title_Reign.sql',-303958494,'atwrpg','2026-09-26 00:49:47',18,1),(100,'101','Add Consecutive Wins To Wrestler','SQL','V101__Add_Consecutive_Wins_To_Wrestler.sql',-1159538110,'atwrpg','2026-09-26 00:49:47',88,1),(101,'102','Add Tournament Segment Rules','SQL','V102__Add_Tournament_Segment_Rules.sql',294797663,'atwrpg','2026-09-26 00:49:48',39,1),(102,'103','Add Wrestler Ability','SQL','V103__Add_Wrestler_Ability.sql',-937427998,'atwrpg','2026-09-26 00:49:48',27,1),(103,'104','Add Unlock Date To Account Achievement','SQL','V104__Add_Unlock_Date_To_Account_Achievement.sql',-355002195,'atwrpg','2026-09-26 00:49:48',13,1),(104,'105','Add PLE Resolution Attempts To Rivalry','SQL','V105__Add_PLE_Resolution_Attempts_To_Rivalry.sql',-1976850971,'atwrpg','2026-09-26 00:49:48',20,1),(105,'106','Track Last PLE Resolution Show','SQL','V106__Track_Last_PLE_Resolution_Show.sql',1288503085,'atwrpg','2026-09-26 00:49:48',23,1),(106,'107','Add Feud Script','SQL','V107__Add_Feud_Script.sql',1332487651,'atwrpg','2026-09-26 00:49:48',37,1),(107,'108','Add Code To Segment Type','SQL','V108__Add_Code_To_Segment_Type.sql',2111048012,'atwrpg','2026-09-26 00:49:48',35,1),(108,'109','Add Contender Match Flag To Segment','SQL','V109__Add_Contender_Match_Flag_To_Segment.sql',1391670763,'atwrpg','2026-09-26 00:49:48',42,1),(109,'110','Add Contender Title To Feud Script Beat','SQL','V110__Add_Contender_Title_To_Feud_Script_Beat.sql',1629128059,'atwrpg','2026-09-26 00:49:48',44,1),(110,'111','Add Wrestler Title Cooldown','SQL','V111__Add_Wrestler_Title_Cooldown.sql',510432771,'atwrpg','2026-09-26 00:49:48',43,1),(111,'112','Add Feud Script Beat Participant','SQL','V112__Add_Feud_Script_Beat_Participant.sql',-1743421478,'atwrpg','2026-09-26 00:49:48',16,1),(112,'113','Add Teams And Titles To Feud Script Beat','SQL','V113__Add_Teams_And_Titles_To_Feud_Script_Beat.sql',1528393933,'atwrpg','2026-09-26 00:49:48',50,1),(113,'114','Upgrade Gemini Model To 3 5 Flash Lite','SQL','V114__Upgrade_Gemini_Model_To_3_5_Flash_Lite.sql',296089759,'atwrpg','2026-09-26 00:49:48',2,1),(114,'115','Add Data Migration History','SQL','V115__Add_Data_Migration_History.sql',1691771798,'atwrpg','2026-09-26 00:49:48',16,1),(115,'116','Add Event Only To Segment Type','SQL','V116__Add_Event_Only_To_Segment_Type.sql',-158485150,'atwrpg','2026-09-26 00:49:48',28,1),(116,'117','Add Template Segment Assignments','SQL','V117__Add_Template_Segment_Assignments.sql',-164165380,'atwrpg','2026-09-26 00:49:48',29,1),(117,'118','Add Tournament To Template Assignments','SQL','V118__Add_Tournament_To_Template_Assignments.sql',-274635857,'atwrpg','2026-09-26 00:49:48',42,1),(118,'119','Add Payoff Show To Tournament','SQL','V119__Add_Payoff_Show_To_Tournament.sql',1870162087,'atwrpg','2026-09-26 00:49:48',170,1),(119,'120','Tournament Match Participants','SQL','V120__Tournament_Match_Participants.sql',1006081520,'atwrpg','2026-09-26 00:49:48',23,1),(120,'121','Tournament Code And Default Entrants','SQL','V121__Tournament_Code_And_Default_Entrants.sql',-1521027697,'atwrpg','2026-09-26 00:49:48',30,1),(121,'122','Add Tournament Spec To Template Assignments','SQL','V122__Add_Tournament_Spec_To_Template_Assignments.sql',648521705,'atwrpg','2026-09-26 00:49:49',112,1),(122,'123','Add Required Expansions To Show Template','SQL','V123__Add_Required_Expansions_To_Show_Template.sql',-236189420,'atwrpg','2026-09-26 00:49:49',10,1),(123,'124','Tournament Editions','SQL','V124__Tournament_Editions.sql',-1925882813,'atwrpg','2026-09-26 00:49:49',90,1),(124,'125','Tournament Qualifier Group Size','SQL','V125__Tournament_Qualifier_Group_Size.sql',-1694866026,'atwrpg','2026-09-26 00:49:49',30,1);
...
CREATE TABLE `inbox_item` (
  ...
  `urgency` varchar(30) NOT NULL DEFAULT 'INFO',
  `action_type` varchar(50) DEFAULT NULL,
  `action_payload` varchar(512) DEFAULT NULL,
  `sender_account_id` bigint DEFAULT NULL,
  PRIMARY KEY (`inbox_item_id`),
  KEY `fk_inbox_sender` (`sender_account_id`),
  CONSTRAINT `fk_inbox_sender` FOREIGN KEY (`sender_account_id`) REFERENCES `account` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `injury_type` VALUES (1,'Legacy Injury',0,0,0,'Placeholder for injuries that existed before injury types were introduced. Update to the correct type when known.'),(2,'Sprain',-2,-1,0,NULL);
...
CREATE TABLE `ringside_action` (
  ...
  `expansion_code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'BASE_GAME',
...
CREATE TABLE `rivalry` (
  ...
  `ple_resolution_attempts` int NOT NULL DEFAULT '0',
  `last_ple_resolution_show_id` bigint DEFAULT NULL,
...
--
-- Table structure for table `season_award`
--
...
CREATE TABLE `season_award` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_sa_wrestler` (`wrestler_id`),
  KEY `idx_sa_season` (`season_id`),
...
--
-- Dumping data for table `season_award`
--

LOCK TABLES `season_award` WRITE;
/*!40000 ALTER TABLE `season_award` DISABLE KEYS */;
/*!40000 ALTER TABLE `season_award` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `segment` (
  ...
  `notes` longtext,
  `rivalry_id` bigint DEFAULT NULL,
  `title_skill_used` tinyint(1) NOT NULL DEFAULT '0',
  `is_contender_match` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `segment_participant` (
  ...
  `final_momentum` int DEFAULT NULL,
  `final_health` int DEFAULT NULL,
  `final_stamina` int DEFAULT NULL,
  `finish_type` varchar(20) DEFAULT NULL,
  `winning_card_name` varchar(255) DEFAULT NULL,
  `cards_played` text,
  `abilities_used` varchar(2000) DEFAULT NULL,
...
CREATE TABLE `segment_rule` (
  ...
  `expansion_code` varchar(50) NOT NULL DEFAULT 'BASE_GAME',
  `rules_json` longtext,
  `rules_hash` varchar(64) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `allows_referee_stoppage` tinyint(1) NOT NULL DEFAULT '1',
...
INSERT INTO `segment_rule` VALUES (1,'Faction Beatdown','A non-match segment where one or more wrestlers are attacked by a group',0,'NONE','2026-09-26 00:49:47',0,'CUSTOM',NULL,NULL,1,1),(2,'GM Office Confrontation','A backstage segment where the player confronts management',0,'NONE','2026-09-26 00:49:47',0,'CUSTOM',NULL,NULL,1,1),(3,'Performance Review','A segment where management evaluates the player\'s status and results',0,'NONE','2026-09-26 00:49:47',0,'CUSTOM',NULL,NULL,1,1);
...
CREATE TABLE `segment_type` (
  ...
  `expansion_code` varchar(50) NOT NULL DEFAULT 'BASE_GAME',
  `guide_json` longtext,
  `guide_hash` varchar(64) DEFAULT NULL,
  `is_active` tinyint(1) NOT NULL DEFAULT '1',
  `code` varchar(64) DEFAULT NULL,
  `event_only` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`segment_type_id`),
  UNIQUE KEY `name` (`name`),
  UNIQUE KEY `uq_segment_type_code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `segment_type` VALUES (1,'Match',NULL,'2026-09-26 00:49:49','BASE_GAME',NULL,NULL,1,NULL,0);
/*!40000 ALTER TABLE `segment_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `show_segment_reservation`
--

DROP TABLE IF EXISTS `show_segment_reservation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `show_segment_reservation` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_ssr_segment` (`segment_id`),
  UNIQUE KEY `uq_ssr_source` (`show_id`,`purpose`,`source_id`),
...
--
-- Dumping data for table `show_segment_reservation`
--

LOCK TABLES `show_segment_reservation` WRITE;
/*!40000 ALTER TABLE `show_segment_reservation` DISABLE KEYS */;
/*!40000 ALTER TABLE `show_segment_reservation` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `show_template` VALUES (1,'Reference Template',NULL,1,NULL,'2026-09-26 00:49:49',NULL,NULL,NULL,1,'NONE',NULL,NULL,NULL,NULL,NULL,NULL,1);
/*!40000 ALTER TABLE `show_template` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `show_template_assignment_rule`
--

DROP TABLE IF EXISTS `show_template_assignment_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `show_template_assignment_rule` (
  `assignment_id` bigint NOT NULL,
  `segment_rule_id` bigint NOT NULL,
  `position` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`assignment_id`,`segment_rule_id`),
  KEY `fk_star_segment_rule` (`segment_rule_id`),
  CONSTRAINT `fk_star_assignment` FOREIGN KEY (`assignment_id`) REFERENCES `show_template_segment_assignment` (`assignment_id`) ON DELETE CASCADE,
  CONSTRAINT `fk_star_segment_rule` FOREIGN KEY (`segment_rule_id`) REFERENCES `segment_rule` (`segment_rule_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `show_template_assignment_rule`
--

LOCK TABLES `show_template_assignment_rule` WRITE;
/*!40000 ALTER TABLE `show_template_assignment_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `show_template_assignment_rule` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `show_template_required_expansion`
--

DROP TABLE IF EXISTS `show_template_required_expansion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `show_template_required_expansion` (
  `template_id` bigint NOT NULL,
  `expansion_code` varchar(64) NOT NULL,
  PRIMARY KEY (`template_id`,`expansion_code`),
  CONSTRAINT `fk_stre_template` FOREIGN KEY (`template_id`) REFERENCES `show_template` (`template_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `show_template_required_expansion`
--

LOCK TABLES `show_template_required_expansion` WRITE;
/*!40000 ALTER TABLE `show_template_required_expansion` DISABLE KEYS */;
/*!40000 ALTER TABLE `show_template_required_expansion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `show_template_segment_assignment`
--

DROP TABLE IF EXISTS `show_template_segment_assignment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `show_template_segment_assignment` (
  `assignment_id` bigint NOT NULL AUTO_INCREMENT,
  `template_id` bigint NOT NULL,
  `segment_type_id` bigint DEFAULT NULL,
  `segment_rule_id` bigint DEFAULT NULL,
  `mode` varchar(20) NOT NULL,
  `creation_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `tournament_id` bigint DEFAULT NULL,
  `spec_name` varchar(255) DEFAULT NULL,
  `spec_format_id` varchar(64) DEFAULT NULL,
  `spec_entrant_count` int DEFAULT NULL,
  `spec_final_rule_id` bigint DEFAULT NULL,
  `spec_title_id` bigint DEFAULT NULL,
  PRIMARY KEY (`assignment_id`),
  KEY `fk_sta_template` (`template_id`),
  KEY `fk_sta_segment_type` (`segment_type_id`),
  KEY `fk_sta_segment_rule` (`segment_rule_id`),
  KEY `fk_sta_tournament` (`tournament_id`),
  KEY `fk_sta_spec_final_rule` (`spec_final_rule_id`),
  KEY `fk_sta_spec_title` (`spec_title_id`),
  ...
  CONSTRAINT `fk_sta_spec_final_rule` FOREIGN KEY (`spec_final_rule_id`) REFERENCES `segment_rule` (`segment_rule_id`),
  CONSTRAINT `fk_sta_spec_title` FOREIGN KEY (`spec_title_id`) REFERENCES `title` (`title_id`),
  CONSTRAINT `fk_sta_template` FOREIGN KEY (`template_id`) REFERENCES `show_template` (`template_id`),
  CONSTRAINT `fk_sta_tournament` FOREIGN KEY (`tournament_id`) REFERENCES `tournament` (`tournament_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `show_template_segment_assignment`
--

LOCK TABLES `show_template_segment_assignment` WRITE;
/*!40000 ALTER TABLE `show_template_segment_assignment` DISABLE KEYS */;
/*!40000 ALTER TABLE `show_template_segment_assignment` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `show_type` VALUES (1,'Weekly Show',NULL,0,0,'2026-09-26 00:49:49',1,'OTHER');
...
CREATE TABLE `title` (
  ...
  `expansion_code` varchar(50) NOT NULL DEFAULT 'BASE_GAME',
  `defense_count` bigint NOT NULL DEFAULT '0',
...
INSERT INTO `title` VALUES (1,'Reference Championship',NULL,NULL,NULL,'SINGLE',1,1,'2026-09-26 00:49:49',NULL,NULL,1,NULL,'BASE_GAME',0);
...
CREATE TABLE `title_reign` (
  ...
  `consecutive_weekly_defenses` int NOT NULL DEFAULT '0',
...
CREATE TABLE `tournament` (
  ...
  `end_date` date DEFAULT NULL,
  `payoff_show_id` bigint DEFAULT NULL,
  `payoff_segment_type_id` bigint DEFAULT NULL,
  `payoff_segment_rule_id` bigint DEFAULT NULL,
  `code` varchar(64) DEFAULT NULL,
  `default_entrant_count` int DEFAULT NULL,
  `parent_tournament_id` bigint DEFAULT NULL,
  `edition_ordinal` int DEFAULT NULL,
  `recurrence` varchar(16) NOT NULL DEFAULT 'NONE',
  `qualifier_group_size` int DEFAULT NULL,
  PRIMARY KEY (`tournament_id`),
  UNIQUE KEY `ux_tournament_code` (`code`),
  KEY `fk_tournament_universe` (`universe_id`),
  KEY `fk_tournament_title` (`title_id`),
  KEY `fk_tournament_payoff_show` (`payoff_show_id`),
  KEY `fk_tournament_payoff_type` (`payoff_segment_type_id`),
  KEY `fk_tournament_payoff_rule` (`payoff_segment_rule_id`),
  KEY `idx_tournament_parent` (`parent_tournament_id`),
  CONSTRAINT `fk_tournament_parent` FOREIGN KEY (`parent_tournament_id`) REFERENCES `tournament` (`tournament_id`),
  CONSTRAINT `fk_tournament_payoff_rule` FOREIGN KEY (`payoff_segment_rule_id`) REFERENCES `segment_rule` (`segment_rule_id`),
  CONSTRAINT `fk_tournament_payoff_show` FOREIGN KEY (`payoff_show_id`) REFERENCES `wrestling_show` (`show_id`),
  CONSTRAINT `fk_tournament_payoff_type` FOREIGN KEY (`payoff_segment_type_id`) REFERENCES `segment_type` (`segment_type_id`),
...
CREATE TABLE `tournament_entry` (
  ...
  `status` varchar(16) NOT NULL DEFAULT 'ACTIVE',
  PRIMARY KEY (`id`),
  KEY `fk_entry_tournament` (`tournament_id`),
  KEY `fk_entry_wrestler` (`wrestler_id`),
...
CREATE TABLE `tournament_match` (
  ...
  `segment_id` bigint DEFAULT NULL,
  `winner_entry_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_match_segment` (`segment_id`),
  KEY `fk_match_round` (`round_id`),
  KEY `fk_match_entrant1` (`entrant1_id`),
  KEY `fk_match_entrant2` (`entrant2_id`),
  KEY `fk_match_winner` (`winner_entry_id`),
...
--
-- Table structure for table `tournament_match_participant`
--

DROP TABLE IF EXISTS `tournament_match_participant`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tournament_match_participant` (
  ...
  `slot` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_tmp_match_slot` (`match_id`,`slot`),
  UNIQUE KEY `uq_tmp_match_entry` (`match_id`,`entry_id`),
  KEY `fk_tmp_entry` (`entry_id`),
  KEY `idx_tmp_match` (`match_id`),
...
--
-- Dumping data for table `tournament_match_participant`
--

LOCK TABLES `tournament_match_participant` WRITE;
/*!40000 ALTER TABLE `tournament_match_participant` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournament_match_participant` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tournament_round` (
  ...
  `segment_rule_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_round_tournament` (`tournament_id`),
  KEY `fk_round_show` (`show_id`),
  KEY `fk_tr_segment_rule` (`segment_rule_id`),
  ...
  CONSTRAINT `fk_tr_segment_rule` FOREIGN KEY (`segment_rule_id`) REFERENCES `segment_rule` (`segment_rule_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tournament_segment_rule`
--

DROP TABLE IF EXISTS `tournament_segment_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tournament_segment_rule` (
  ...
  KEY `fk_tsr_segment_rule` (`segment_rule_id`),
  CONSTRAINT `fk_tsr_segment_rule` FOREIGN KEY (`segment_rule_id`) REFERENCES `segment_rule` (`segment_rule_id`),
  CONSTRAINT `fk_tsr_tournament` FOREIGN KEY (`tournament_id`) REFERENCES `tournament` (`tournament_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tournament_segment_rule`
--

LOCK TABLES `tournament_segment_rule` WRITE;
/*!40000 ALTER TABLE `tournament_segment_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `tournament_segment_rule` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `universe` VALUES (1,'Default Universe','GLOBAL','2026-09-26 00:49:43');
...
CREATE TABLE `universe_invite` (
  ...
  CONSTRAINT `fk_invite_created_by` FOREIGN KEY (`created_by`) REFERENCES `account` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `universe_join_request` (
  ...
  CONSTRAINT `fk_request_resolved_by` FOREIGN KEY (`resolved_by`) REFERENCES `account` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `universe_members` (
  ...
  CONSTRAINT `fk_um_account` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE CASCADE,
...
INSERT INTO `universe_members` VALUES (1,1,1,'MEMBER','2026-09-26 00:49:43'),(2,1,2,'MEMBER','2026-09-26 00:49:43'),(3,1,3,'MEMBER','2026-09-26 00:49:43'),(4,1,4,'MEMBER','2026-09-26 00:49:43');
...
INSERT INTO `wrestler` VALUES (1,'Reference Wrestler',12,2,12,2,12,'2026-09-26 00:49:49',0,'MALE',NULL,NULL,1,NULL,1,1,1,1,NULL,'BASE_GAME',0),(2,'Reference Wrestler 2',14,3,14,3,14,'2026-09-26 00:49:49',0,'FEMALE',NULL,NULL,1,NULL,1,1,1,1,NULL,'BASE_GAME',0);
/*!40000 ALTER TABLE `wrestler` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wrestler_ability`
--

DROP TABLE IF EXISTS `wrestler_ability`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wrestler_ability` (
  `wrestler_ability_id` bigint NOT NULL AUTO_INCREMENT,
  `wrestler_id` bigint NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text,
  ...
  `cost_script` text,
  `effect_script` text,
  PRIMARY KEY (`wrestler_ability_id`),
  UNIQUE KEY `uq_wa_wrestler_name` (`wrestler_id`,`name`),
  CONSTRAINT `fk_wrestler_ability_wrestler` FOREIGN KEY (`wrestler_id`) REFERENCES `wrestler` (`wrestler_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `wrestler_ability`
--

LOCK TABLES `wrestler_ability` WRITE;
/*!40000 ALTER TABLE `wrestler_ability` DISABLE KEYS */;
/*!40000 ALTER TABLE `wrestler_ability` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `wrestler_state` VALUES (1,1,1,1000,'ROOKIE',0,12,100,100,100,NULL,NULL,'2026-09-26 00:49:49'),(2,2,1,500,'VETERAN',2,14,100,100,100,NULL,NULL,'2026-09-26 00:49:49');
/*!40000 ALTER TABLE `wrestler_state` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `wrestler_state_history`
--

DROP TABLE IF EXISTS `wrestler_state_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wrestler_state_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_wsh_universe` (`universe_id`),
  KEY `idx_wsh_lookup` (`wrestler_id`,`universe_id`,`recorded_at`),
...
--
-- Dumping data for table `wrestler_state_history`
--

LOCK TABLES `wrestler_state_history` WRITE;
/*!40000 ALTER TABLE `wrestler_state_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `wrestler_state_history` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `wrestler_title_cooldown`
--

DROP TABLE IF EXISTS `wrestler_title_cooldown`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `wrestler_title_cooldown` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_wtc_state_title` (`wrestler_state_id`,`title_id`),
  KEY `fk_wtc_title` (`title_id`),
...
--
-- Dumping data for table `wrestler_title_cooldown`
--

LOCK TABLES `wrestler_title_cooldown` WRITE;
/*!40000 ALTER TABLE `wrestler_title_cooldown` DISABLE KEYS */;
/*!40000 ALTER TABLE `wrestler_title_cooldown` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `wrestling_show` (
  ...
  `booking_mode` varchar(50) NOT NULL DEFAULT 'STANDARD',
  PRIMARY KEY (`show_id`),
  KEY `show_type_id` (`show_type_id`),
  KEY `season_id` (`season_id`),
...
INSERT INTO `wrestling_show` VALUES (1,'Reference Show',NULL,NULL,1,NULL,NULL,'2026-09-26 00:49:49',NULL,NULL,NULL,0,0.00,1,NULL,'STANDARD');
...
-- Dump completed on 2026-09-26  0:49:50
