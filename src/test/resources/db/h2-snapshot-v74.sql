...
;              
CREATE USER IF NOT EXISTS "SA" SALT '0cc114cd37a28913' HASH '4e43b9a9d7ce172e1a89a1c85ef9c1526287e14f803a3e2d5f7a11d80c73c643' ADMIN;          
...
-- 73 +/- SELECT COUNT(*) FROM PUBLIC.flyway_schema_history;   
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(-1, NULL, '<< Flyway Schema History table created >>', 'TABLE', '', NULL, 'SA', TIMESTAMP '2026-05-22 16:41:55.040009', 0, TRUE),
(1, '1', 'Initial Schema', 'SQL', 'V1__Initial_Schema.sql', 1115964703, 'SA', TIMESTAMP '2026-05-22 16:41:55.11804', 50, TRUE),
(2, '2', 'DeckCard SetId', 'SQL', 'V2__DeckCard_SetId.sql', -788503740, 'SA', TIMESTAMP '2026-05-22 16:41:55.130066', 6, TRUE),
(3, '3', 'Add CardSet Name Column', 'SQL', 'V3__Add_CardSet_Name_Column.sql', 118948041, 'SA', TIMESTAMP '2026-05-22 16:41:55.138754', 4, TRUE),
(4, '4', 'Update Card Unique Constraint', 'SQL', 'V4__Update_Card_Unique_Constraint.sql', 659202034, 'SA', TIMESTAMP '2026-05-22 16:41:55.143048', 0, TRUE),
(5, '5', 'Add Adjudication Status To Segment', 'SQL', 'V5__Add_Adjudication_Status_To_Segment.sql', 2134148974, 'SA', TIMESTAMP '2026-05-22 16:41:55.150221', 4, TRUE),
(6, '6', 'Add Segment Order And Main Event', 'SQL', 'V6__Add_Segment_Order_And_Main_Event.sql', 619297846, 'SA', TIMESTAMP '2026-05-22 16:41:55.160598', 7, TRUE),
(7, '7', 'Add Inbox Item Table', 'SQL', 'V7__Add_Inbox_Item_Table.sql', 968071477, 'SA', TIMESTAMP '2026-05-22 16:41:55.165282', 1, TRUE),
(8, '8', 'Add Reference Id To Inbox Item', 'SQL', 'V8__Add_Reference_Id_To_Inbox_Item.sql', 989049951, 'SA', TIMESTAMP '2026-05-22 16:41:55.170506', 1, TRUE),
(9, '9', 'Add Bump Addition To Segment Rule', 'SQL', 'V9__Add_Bump_Addition_To_Segment_Rule.sql', 1037211787, 'SA', TIMESTAMP '2026-05-22 16:41:55.175437', 2, TRUE),
(10, '10', 'Add Image Url To Wrestler', 'SQL', 'V10__Add_Image_Url_To_Wrestler.sql', -1445120071, 'SA', TIMESTAMP '2026-05-22 16:41:55.182437', 4, TRUE),
(11, '11', 'Add Expected Matches And Promos To ShowType', 'SQL', 'V11__Add_Expected_Matches_And_Promos_To_ShowType.sql', -1728232004, 'SA', TIMESTAMP '2026-05-22 16:41:55.18914', 4, TRUE),
(12, '12', 'Add Last Sync To Entities', 'SQL', 'V12__Add_Last_Sync_To_Entities.sql', 1145996377, 'SA', TIMESTAMP '2026-05-22 16:41:55.208376', 17, TRUE),
(13, '13', 'Add External Id And Last Sync To SegmentRule', 'SQL', 'V13__Add_External_Id_And_Last_Sync_To_SegmentRule.sql', -566008599, 'SA', TIMESTAMP '2026-05-22 16:41:55.234806', 24, TRUE),
(14, '14', 'Add External Id And Last Sync To Show Template', 'SQL', 'V14__Add_External_Id_And_Last_Sync_To_Show_Template.sql', -1336096513, 'SA', TIMESTAMP '2026-05-22 16:41:55.239657', 2, TRUE),
(15, '15', 'Add Missing Sync Fields', 'SQL', 'V15__Add_Missing_Sync_Fields.sql', 1365334389, 'SA', TIMESTAMP '2026-05-22 16:41:55.273496', 31, TRUE),
(16, '16', 'Create Tier Boundary Table', 'SQL', 'V16__Create_Tier_Boundary_Table.sql', -1179887120, 'SA', TIMESTAMP '2026-05-22 16:41:55.27913', 0, TRUE),
(17, '18', 'Add Inbox Item Target', 'SQL', 'V18__Add_Inbox_Item_Target.sql', -1149624846, 'SA', TIMESTAMP '2026-05-22 16:41:55.283012', 1, TRUE),
(18, '19', 'Remove Reference Id From Inbox Item', 'SQL', 'V19__Remove_Reference_Id_From_Inbox_Item.sql', -1540103389, 'SA', TIMESTAMP '2026-05-22 16:41:55.288329', 2, TRUE),
(19, '20', 'Create Account Tables', 'SQL', 'V20__Create_Account_Tables.sql', 1011977414, 'SA', TIMESTAMP '2026-05-22 16:41:55.294978', 3, TRUE),
(20, '21', 'Insert Default Accounts', 'SQL', 'V21__Insert_Default_Accounts.sql', -1923279678, 'SA', TIMESTAMP '2026-05-22 16:41:55.304074', 4, TRUE),
(21, '22', 'Add Account To Wrestler', 'SQL', 'V22__Add_Account_To_Wrestler.sql', 76510181, 'SA', TIMESTAMP '2026-05-22 16:41:55.310702', 4, TRUE),
(22, '23', 'Rename feud heat event column', 'SQL', 'V23__Rename_feud_heat_event_column.sql', -497843593, 'SA', TIMESTAMP '2026-05-22 16:41:55.314052', 0, TRUE),
(23, '24', 'Create Game Setting Table', 'SQL', 'V24__Create_Game_Setting_Table.sql', 795307327, 'SA', TIMESTAMP '2026-05-22 16:41:55.317103', 0, TRUE),
(24, '25', 'Create Password Reset Token Table', 'SQL', 'V25__Create_Password_Reset_Token_Table.sql', -332824989, 'SA', TIMESTAMP '2026-05-22 16:41:55.320261', 0, TRUE),
(25, '26', 'Add Championship Type To Title', 'SQL', 'V26__Add_Championship_Type_To_Title.sql', -96901047, 'SA', TIMESTAMP '2026-05-22 16:41:55.323943', 1, TRUE);            
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(26, '27', 'Add AI Settings', 'SQL', 'V27__Add_AI_Settings.sql', 1962182044, 'SA', TIMESTAMP '2026-05-22 16:41:55.327676', 0, TRUE),
(27, '28', 'Add Active To Wrestler', 'SQL', 'V28__Add_Active_To_Wrestler.sql', -338805172, 'SA', TIMESTAMP '2026-05-22 16:41:55.334462', 3, TRUE),
(28, '29', 'Create Holiday Table', 'SQL', 'V29__Create_Holiday_Table.sql', 599478441, 'SA', TIMESTAMP '2026-05-22 16:41:55.337021', 0, TRUE),
(29, '30', 'Populate Holiday Table', 'SQL', 'V30__Populate_Holiday_Table.sql', -1793461912, 'SA', TIMESTAMP '2026-05-22 16:41:55.343369', 1, TRUE),
(30, '31', 'Add Manager To Wrestler And Faction And Team', 'SQL', 'V31__Add_Manager_To_Wrestler_And_Faction_And_Team.sql', 378765621, 'SA', TIMESTAMP '2026-05-22 16:41:55.357167', 11, TRUE),
(31, '32', 'Add Description To Npc', 'SQL', 'V32__Add_Description_To_Npc.sql', 630994349, 'SA', TIMESTAMP '2026-05-22 16:41:55.360852', 1, TRUE),
(32, '33', 'Add Include In Rankings To Title', 'SQL', 'V33__Add_Include_In_Rankings_To_Title.sql', -647497361, 'SA', TIMESTAMP '2026-05-22 16:41:55.364583', 1, TRUE),
(33, '34', 'Add Won At Segment To Title Reign', 'SQL', 'V34__Add_Won_At_Segment_To_Title_Reign.sql', -332785961, 'SA', TIMESTAMP '2026-05-22 16:41:55.368696', 2, TRUE),
(34, '35', 'Rename Show Table', 'SQL', 'V35__Rename_Show_Table.sql', -888951185, 'SA', TIMESTAMP '2026-05-22 16:41:55.371563', 0, TRUE),
(35, '36', 'Add Unique Constraint To Wrestler Account', 'SQL', 'V36__Add_Unique_Constraint_To_Wrestler_Account.sql', -1288629724, 'SA', TIMESTAMP '2026-05-22 16:41:55.373921', 0, TRUE),
(36, '37', 'Create Campaign System', 'SQL', 'V37__Create_Campaign_System.sql', 1504350749, 'SA', TIMESTAMP '2026-05-22 16:41:55.401768', 18, TRUE),
(37, '38', 'Add Theme Preference And Default Setting', 'SQL', 'V38__Add_Theme_Preference_And_Default_Setting.sql', -913225845, 'SA', TIMESTAMP '2026-05-22 16:41:55.40751', 3, TRUE),
(38, '39', 'Add League System', 'SQL', 'V39__Add_League_System.sql', 602764493, 'SA', TIMESTAMP '2026-05-22 16:41:55.420666', 9, TRUE),
(39, '41', 'Add Image Url To Npc', 'SQL', 'V41__Add_Image_Url_To_Npc.sql', -1391881153, 'SA', TIMESTAMP '2026-05-22 16:41:55.42656', 2, TRUE),
(40, '42', 'Add Image Url To Show Template', 'SQL', 'V42__Add_Image_Url_To_Show_Template.sql', 2091528606, 'SA', TIMESTAMP '2026-05-22 16:41:55.430123', 1, TRUE),
(41, '43', 'Add Expected Matches And Promos To ShowTemplate', 'SQL', 'V43__Add_Expected_Matches_And_Promos_To_ShowTemplate.sql', -1363888031, 'SA', TIMESTAMP '2026-05-22 16:41:55.433515', 1, TRUE),
(42, '44', 'Add Recurrence And Defense Frequency', 'SQL', 'V44__Add_Recurrence_And_Defense_Frequency.sql', -33215304, 'SA', TIMESTAMP '2026-05-22 16:41:55.445421', 9, TRUE),
(43, '45', 'Remove LocalAI Settings', 'SQL', 'V45__Remove_LocalAI_Settings.sql', -2084740732, 'SA', TIMESTAMP '2026-05-22 16:41:55.449654', 1, TRUE),
(44, '46', 'Create Commentary Tables', 'SQL', 'V46__Create_Commentary_Tables.sql', 1578209880, 'SA', TIMESTAMP '2026-05-22 16:41:55.461561', 9, TRUE),
(45, '47', 'Create News Tables', 'SQL', 'V47__Create_News_Tables.sql', -2003982983, 'SA', TIMESTAMP '2026-05-22 16:41:55.464186', 0, TRUE),
(46, '48', 'Add Gender Constraint To ShowTemplate', 'SQL', 'V48__Add_Gender_Constraint_To_ShowTemplate.sql', -1162501534, 'SA', TIMESTAMP '2026-05-22 16:41:55.468932', 2, TRUE),
(47, '49', 'Add Legacy Fields To Account', 'SQL', 'V49__Add_Legacy_Fields_To_Account.sql', -508336936, 'SA', TIMESTAMP '2026-05-22 16:41:55.479096', 7, TRUE),
(48, '50', 'Create Achievement Tables', 'SQL', 'V50__Create_Achievement_Tables.sql', 533959700, 'SA', TIMESTAMP '2026-05-22 16:41:55.483426', 2, TRUE),
(49, '51', 'Add Affinity To Faction', 'SQL', 'V51__Add_Affinity_To_Faction.sql', 1676214726, 'SA', TIMESTAMP '2026-05-22 16:41:55.486949', 1, TRUE),
(50, '52', 'Remove Rivalry Unique Constraint', 'SQL', 'V52__Remove_Rivalry_Unique_Constraint.sql', 858104277, 'SA', TIMESTAMP '2026-05-22 16:41:56.013752', 524, TRUE),
(51, '53', 'Create Storyline Tables', 'SQL', 'V53__Create_Storyline_Tables.sql', 1034900586, 'SA', TIMESTAMP '2026-05-22 16:41:56.021965', 5, TRUE);  
INSERT INTO "PUBLIC"."flyway_schema_history" VALUES
(52, '54', 'Add Npc Attributes', 'SQL', 'V54__Add_Npc_Attributes.sql', 1944315555, 'SA', TIMESTAMP '2026-05-22 16:41:56.025878', 1, TRUE),
(53, '55', 'Add Referee To Segment', 'SQL', 'V55__Add_Referee_To_Segment.sql', -14042474, 'SA', TIMESTAMP '2026-05-22 16:41:56.032205', 4, TRUE),
(54, '56', 'Add No Dq To Segment Rule', 'SQL', 'V56__Add_No_Dq_To_Segment_Rule.sql', 621834710, 'SA', TIMESTAMP '2026-05-22 16:41:56.03504', 1, TRUE),
(55, '57', 'Add Ringside Actions', 'SQL', 'V57__Add_Ringside_Actions.sql', 551019052, 'SA', TIMESTAMP '2026-05-22 16:41:56.038381', 1, TRUE),
(56, '58', 'Add Physical Condition To Wrestler', 'SQL', 'V58__Add_Physical_Condition_To_Wrestler.sql', -2031017789, 'SA', TIMESTAMP '2026-05-22 16:41:56.042825', 2, TRUE),
(57, '59', 'Create Location Arena Tables And Link Show', 'SQL', 'V59__Create_Location_Arena_Tables_And_Link_Show.sql', -777877363, 'SA', TIMESTAMP '2026-05-22 16:41:56.051663', 6, TRUE),
(58, '60', 'Remove Wrestler Account Unique Constraint', 'SQL', 'V60__Remove_Wrestler_Account_Unique_Constraint.sql', -1366350250, 'SA', TIMESTAMP '2026-05-22 16:41:56.053782', 0, TRUE),
(59, '61', 'Add Faction Alignment And Team Fields', 'SQL', 'V61__Add_Faction_Alignment_And_Team_Fields.sql', -393460592, 'SA', TIMESTAMP '2026-05-22 16:41:56.06006', 4, TRUE),
(60, '62', 'Add Updated At To Entities', 'SQL', 'V62__Add_Updated_At_To_Entities.sql', 588199953, 'SA', TIMESTAMP '2026-05-22 16:41:56.101703', 38, TRUE),
(61, '63', 'Initialize Set Enablement Settings', 'SQL', 'V63__Initialize_Set_Enablement_Settings.sql', 727117897, 'SA', TIMESTAMP '2026-05-22 16:41:56.104031', 0, TRUE),
(62, '64', 'Add Expansion Code To Wrestler', 'SQL', 'V64__Add_Expansion_Code_To_Wrestler.sql', -911082154, 'SA', TIMESTAMP '2026-05-22 16:41:56.108421', 2, TRUE),
(63, '65', 'Add Expansion Code To Npc', 'SQL', 'V65__Add_Expansion_Code_To_Npc.sql', 1736603957, 'SA', TIMESTAMP '2026-05-22 16:41:56.111243', 1, TRUE),
(64, '66', 'Add Image Url To Various Entities', 'SQL', 'V66__Add_Image_Url_To_Various_Entities.sql', 1061733307, 'SA', TIMESTAMP '2026-05-22 16:41:56.116658', 3, TRUE),
(65, '67', 'Create Wrestler Relationship Table', 'SQL', 'V67__Create_Wrestler_Relationship_Table.sql', -401169771, 'SA', TIMESTAMP '2026-05-22 16:41:56.120255', 1, TRUE),
(66, '68', 'Add GM Mode Financials And Logistics', 'SQL', 'V68__Add_GM_Mode_Financials_And_Logistics.sql', 1914270991, 'SA', TIMESTAMP '2026-05-22 16:41:56.133579', 11, TRUE),
(67, '69', 'Add Effect Script To Title', 'SQL', 'V69__Add_Effect_Script_To_Title.sql', 1842801306, 'SA', TIMESTAMP '2026-05-22 16:41:56.137665', 2, TRUE),
(68, '70', 'Add Show Attendance And Revenue', 'SQL', 'V70__Add_Show_Attendance_And_Revenue.sql', 1941232678, 'SA', TIMESTAMP '2026-05-22 16:41:56.142094', 2, TRUE),
(69, '71', 'Add Notes To Segment', 'SQL', 'V71__Add_Notes_To_Segment.sql', 1957484762, 'SA', TIMESTAMP '2026-05-22 16:41:56.145232', 1, TRUE),
(70, '72', 'Create Status Card Tables', 'SQL', 'V72__Create_Status_Card_Tables.sql', -1660610380, 'SA', TIMESTAMP '2026-05-22 16:41:56.14915', 2, TRUE),
(71, '73', 'add campaign ability card constraint', 'SQL', 'V73__add_campaign_ability_card_constraint.sql', 215371348, 'SA', TIMESTAMP '2026-05-22 16:41:56.150606', 0, TRUE),
(72, '74', 'Add Team Number To Segment Participant', 'SQL', 'V74__Add_Team_Number_To_Segment_Participant.sql', -1799038452, 'SA', TIMESTAMP '2026-05-22 16:41:56.153718', 1, TRUE);          
...
(1, 'admin', '$2a$10$wKGJ2IuP7HwMP66VaqSdYuqo3S1lcXpl9oqQkTGuLaDYHfbH57hD6', 'admin@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-05-22 16:41:55.300637', TIMESTAMP '2026-05-22 16:41:55.300637', NULL, NULL, 0, 0, 0),
(2, 'booker', '$2a$10$OrFNvKFkH5s/DvDzd301Me4v9bpIulbPNasymqmaxCqaUM.kVXHEi', 'booker@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-05-22 16:41:55.300637', TIMESTAMP '2026-05-22 16:41:55.300637', NULL, NULL, 0, 0, 0),
(3, 'player', '$2a$10$oHciydemMfshOLiGK7g4KO.Epu07svrzinu7PFvdJws5PYK3pIKx.', 'player@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-05-22 16:41:55.300637', TIMESTAMP '2026-05-22 16:41:55.300637', NULL, NULL, 0, 0, 0),
(4, 'viewer', '$2a$10$no8XHshPMFd14eBxIs9e2uYW8bXm/pT6MOZsXnw.RHyhmRWgvok06', 'viewer@atwrpg.local', TRUE, TRUE, TRUE, TRUE, 0, NULL, NULL, TIMESTAMP '2026-05-22 16:41:55.300637', TIMESTAMP '2026-05-22 16:41:55.300637', NULL, NULL, 0, 0, 0);    
...
-- 24 +/- SELECT COUNT(*) FROM PUBLIC.GAME_SETTING;            
...
(1, 'Reference Show', NULL, NULL, 1, NULL, NULL, NULL, TIMESTAMP '2026-05-22 16:41:56.199623', NULL, NULL, NULL, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.199623-05', 0, 0.00);        
...
(1, 'Reference Template', NULL, 1, NULL, NULL, TIMESTAMP '2026-05-22 16:41:56.199355', NULL, NULL, NULL, NULL, 1, 'NONE', NULL, NULL, NULL, NULL, NULL, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.199355-05');           
...
(1, 'Match', NULL, TIMESTAMP '2026-05-22 16:41:56.200107', NULL, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.200107-05');   
...
(1, 'Reference Event', 'Test drama event', 'BACKSTAGE_INCIDENT', 'NEUTRAL', TIMESTAMP '2026-05-22 16:41:56.199784', TIMESTAMP '2026-05-22 16:41:56.199784', NULL, NULL, FALSE, FALSE, FALSE, FALSE, NULL, NULL, NULL, NULL, NULL, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.199784-05');   
...
CREATE CACHED TABLE "PUBLIC"."WRESTLER"(
    ...
    "MANAGEMENT_STAMINA" INTEGER DEFAULT 100 NOT NULL
);         
...
(1, 'Reference Wrestler', 12, 2, 12, 2, 12, TIMESTAMP '2026-05-22 16:41:56.198696', NULL, 1000, 'ROOKIE', 0, 12, FALSE, 'MALE', NULL, NULL, NULL, NULL, NULL, TRUE, NULL, 1, 1, 1, 1, 100, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.198696-05', 'BASE_GAME', 100, 100),
(2, 'Reference Wrestler 2', 14, 3, 14, 3, 14, TIMESTAMP '2026-05-22 16:41:56.198926', NULL, 500, 'VETERAN', 2, 14, FALSE, 'FEMALE', NULL, NULL, NULL, NULL, NULL, TRUE, NULL, 1, 1, 1, 1, 100, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.198926-05', 'BASE_GAME', 100, 100);               
...
(1, 'Weekly Show', NULL, FALSE, TIMESTAMP '2026-05-22 16:41:56.199138', 0, 0, NULL, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.199138-05');   
...
CREATE CACHED TABLE "PUBLIC"."INJURY_TYPE"(
    "INJURY_TYPE_ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1 RESTART WITH 2) NOT NULL,
...
(1, 'Sprain', -2, -1, 0, NULL, NULL, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.199001-05');
...
(1, 1, 'ACTIVE', TIMESTAMP '2026-05-22 16:41:56.19989', NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.19989-05'); 
...
(1, 'Test Faction', 'Reference snapshot faction', TRUE, NULL, NULL, NULL, TIMESTAMP '2026-05-22 16:41:56.198341', NULL, NULL, NULL, 0, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.198341-05', NULL);            
...
(1, 'Reference Championship', NULL, NULL, NULL, TRUE, TIMESTAMP '2026-05-22 16:41:56.199074', NULL, NULL, 'SINGLE', TRUE, NULL, TIMESTAMP WITH TIME ZONE '2026-05-22 16:41:56.199074-05', NULL, NULL);     
...
ALTER TABLE "PUBLIC"."WRESTLER" ADD CONSTRAINT "PUBLIC"."FK_WRESTLER_MANAGER" FOREIGN KEY("MANAGER_ID") REFERENCES "PUBLIC"."NPC"("ID") NOCHECK;               
...
ALTER TABLE "PUBLIC"."WRESTLER" ADD CONSTRAINT "PUBLIC"."CONSTRAINT_B9B" FOREIGN KEY("FACTION_ID") REFERENCES "PUBLIC"."FACTION"("FACTION_ID") ON DELETE SET NULL NOCHECK;     
