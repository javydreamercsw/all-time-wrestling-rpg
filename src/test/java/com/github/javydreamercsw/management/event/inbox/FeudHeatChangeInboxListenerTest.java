...
class FeudHeatChangeInboxListenerTest {

  private InboxService inboxService;
  private InboxEventType feudHeatChange;
  ...
  void testOnApplicationEvent() {
    ...
    FeudHeatChangeEvent event = mock(FeudHeatChangeEvent.class);
    when(event.getFeudName()).thenReturn("Feud Name");
    ...
    when(event.getFeudId()).thenReturn(123L);
