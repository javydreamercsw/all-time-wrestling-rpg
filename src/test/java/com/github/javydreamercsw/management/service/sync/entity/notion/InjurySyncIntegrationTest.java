...
class InjurySyncIntegrationTest extends ManagementIntegrationTest {
  ...
  void shouldSyncSpecificInjuryTypesWithCorrectData() {
    ...
    BaseSyncService.SyncResult result = notionSyncService.syncInjuryTypes("data-accuracy-test");
    assertThat(result.isSuccess()).isTrue();
  ...
  void shouldMaintainReferentialIntegrityDuringSync() {
    ...
    // When - Sync injury types
    BaseSyncService.SyncResult result = notionSyncService.syncInjuryTypes("integrity-test");
