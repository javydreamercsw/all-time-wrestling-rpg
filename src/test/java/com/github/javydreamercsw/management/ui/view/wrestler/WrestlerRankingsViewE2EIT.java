...
public class WrestlerRankingsViewE2EIT extends AbstractE2ETest {
  ...
  @MockitoSpyBean private CustomUserDetailsService customUserDetailsService;
  ...
  public void setupChampion() {
    ...
    UserDetails user = new User("admin", passwordEncoder.encode("admin123"), new ArrayList<>());
    when(customUserDetailsService.loadUserByUsername("admin")).thenReturn(user);
  }
