...
public class SegmentNarrationConfig {
  ...
  /** AI provider settings for segment narration. */
  ...
  public static class WordCount {
    /** Minimum words for a complete segment narration. */
    private int minimum = 1500;

    /** Maximum words for a complete segment narration. */
    private int maximum = 2500;

    /** Target words for optimal segment length. */
