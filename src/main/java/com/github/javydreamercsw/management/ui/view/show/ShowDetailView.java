...
public class ShowDetailView extends Main
  ...
  private Component createOrderButtons(@NonNull Segment segment) {
    ...
    upButton.setId("move-segment-up-button");
    ...
    downButton.setId("move-segment-down-button");
  ...
  private Component createActionButtons(@NonNull Segment segment) {
    ...
    summaryButton.setId("generate-summary-button");
    ...
    narrateButton.setId("generate-narration-button");
    ...
    editButton.setId("edit-segment-button");
    ...
    deleteButton.setId("delete-segment-button");
