...
public interface TournamentEntryRepository extends JpaRepository<TournamentEntry, Long> {
  ...
  List<TournamentEntry> findByTournamentIdAndStatus(
      Long tournamentId, TournamentEntryStatus status);

  long countByTournamentId(Long tournamentId);

  boolean existsByTournamentIdAndWrestlerId(Long tournamentId, Long wrestlerId);
}
