...
/**
 * Represents a single heat-generating event in a multi-wrestler feud. Tracks what happened, when,
 * and how much heat was gained/lost.
 */
@Entity
@Table(name = "feud_heat_event")
@Getter
@Setter
public class FeudHeatEvent extends AbstractEntity<Long> {
  ...
  /** Get feud name for this event. */
  public String getFeudName() {
    if (feud != null) {
      return feud.getName();
    }
    return "Unknown Feud";
