...
@Converter
@Slf4j
public class StringToStringIntegerMapConverter
  ...
  public String convertToDatabaseColumn(final Map<String, Integer> attribute) {
    ...
    try {
      ...
      log.error("Error converting card-play map to JSON", e);
      return "{}";
    }
  }

  @Override
  public Map<String, Integer> convertToEntityAttribute(final String dbData) {
    ...
    try {
      ...
      log.error("Error converting JSON to card-play map", e);
      return new HashMap<>();
    }
  }
}
