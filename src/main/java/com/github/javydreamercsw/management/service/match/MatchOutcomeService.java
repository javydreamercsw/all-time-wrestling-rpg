...
public class MatchOutcomeService implements MatchOutcomeProvider {
  ...
  public MatchNarrationContext determineOutcomeIfNeeded(MatchNarrationContext context) {
    ...
    if (context.getDeterminedOutcome() != null
      ...
      log.debug("Match outcome already determined: {}", context.getDeterminedOutcome());
      return context;
    }
    ...
    if (context.getWrestlers() == null || context.getWrestlers().isEmpty()) {
      ...
      context.setDeterminedOutcome("Match ends in a no contest due to insufficient participants");
      return context;
    }
