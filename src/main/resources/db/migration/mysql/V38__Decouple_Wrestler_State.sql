...
-- Note: creation_date updates are removed to avoid SQL errors during migration 
-- if columns are already managed by other migrations.
UPDATE wrestler SET universe_id = 1;
