...
ALTER TABLE tournament
  ADD COLUMN payoff_show_id BIGINT;

ALTER TABLE tournament
  ADD COLUMN payoff_segment_type_id BIGINT;

ALTER TABLE tournament
  ADD COLUMN payoff_segment_rule_id BIGINT;

ALTER TABLE tournament
  ADD CONSTRAINT fk_tournament_payoff_show FOREIGN KEY (payoff_show_id)
    REFERENCES wrestling_show (show_id);

ALTER TABLE tournament
  ADD CONSTRAINT fk_tournament_payoff_type FOREIGN KEY (payoff_segment_type_id)
    REFERENCES segment_type (segment_type_id);

ALTER TABLE tournament
  ADD CONSTRAINT fk_tournament_payoff_rule FOREIGN KEY (payoff_segment_rule_id)
