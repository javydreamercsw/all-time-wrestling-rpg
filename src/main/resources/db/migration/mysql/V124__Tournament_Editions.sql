...
ALTER TABLE tournament
  ADD COLUMN parent_tournament_id BIGINT NULL,
  ADD COLUMN edition_ordinal INT NULL,
  ADD COLUMN recurrence VARCHAR(16) NOT NULL DEFAULT 'NONE';

ALTER TABLE tournament
  ADD CONSTRAINT fk_tournament_parent FOREIGN KEY (parent_tournament_id)
  REFERENCES tournament (tournament_id);
CREATE INDEX idx_tournament_parent ON tournament (parent_tournament_id);
