...
ALTER TABLE show_template_segment_assignment ADD COLUMN IF NOT EXISTS spec_name VARCHAR(255);
ALTER TABLE show_template_segment_assignment ADD COLUMN IF NOT EXISTS spec_format_id VARCHAR(64);
ALTER TABLE show_template_segment_assignment ADD COLUMN IF NOT EXISTS spec_entrant_count INT;
ALTER TABLE show_template_segment_assignment
  ADD COLUMN IF NOT EXISTS spec_final_rule_id BIGINT;
ALTER TABLE show_template_segment_assignment ADD COLUMN IF NOT EXISTS spec_title_id BIGINT;
ALTER TABLE show_template_segment_assignment
